<template>
  <div :class="b()" v-if="isShow">
    <div :class="b('mask')" v-if="ops.modal" @click="close"></div>
    ...
    <div :class="b('box')" ref="box">
      <component
        ...
        <component
          ...
          <img
            v-if="
              $typeList.img.test(item.url) || $typeList.video.test(item.url)
            "
            :src="item.url"
