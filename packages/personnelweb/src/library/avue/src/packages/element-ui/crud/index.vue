...
export default create({
  ...
  methods: {
    ...
    vaildErrorItem(item, msg) {
      let form = this.$refs.headerSearch.$refs.form.$refs.form.fields.filter(item2 => item2.prop == item)[0];
    ...
    getTableHeight() {
      if (this.isAutoHeight) {
        this.$nextTick(() => {
          ...
          this.tableHeight = config.clientHeight - tableStyle.offsetTop - pageStyle - headerSearchStyle - this.calcHeight
        })
      } else {
