  ...
  <el-col
    ...
    <el-form-item label-width="0px">
      <el-button
        ...
        >{{
          vaildData(formSafe.parentOption.mockText, t('form.mockBtn'))
        }}</el-button
      >
      <el-button
        type="primary"
        ...
        >{{
          vaildData(formSafe.parentOption.printText, t('form.printBtn'))
        }}</el-button
      >
      <el-button
        type="primary"
        ...
        >{{
          vaildData(formSafe.parentOption.submitText, t('form.submitBtn'))
        }}</el-button
      >
      <el-button
        ...
        >{{
          vaildData(formSafe.parentOption.emptyText, t('form.emptyBtn'))
        }}</el-button
      >
      <slot
        name="menuForm"
