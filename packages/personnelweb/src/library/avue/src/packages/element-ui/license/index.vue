<template>
  <div :class="b()" style="position: relative">
    <canvas :id="'canvas' + id" ref="canvas"></canvas>
    <slot></slot>
  </div>
</template>
  ...
  methods: {
    init() {
      ...
      beauty.onload = () => {
        ...
        const height = this.option.width
          ? (beauty.height / beauty.width) * this.option.width
          : beauty.height
        ...
        this.list.forEach((ele, index) => {
          ...
          if (ele.img) {
            ...
            img.onload = () => {
              ...
              const heights = ele.width
                ? (img.height / img.width) * ele.width
                : img.height
