<template>
  <div :class="b()">
    <div :class="b('filter')" v-if="vaildData(option.filter, true)">
      <el-input
        :placeholder="vaildData(option.filterText, '输入关键字进行过滤')"
        :size="size"
        v-model="filterValue">
        <el-button
          slot="append"
        ...
        <slot v-else name="addBtn" slot="append"></slot>
      </el-input>
    </div>
    ...
    <div
      class="el-cascader-panel is-bordered"
