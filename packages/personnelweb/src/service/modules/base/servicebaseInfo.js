...
export function saveServcards(params) {
    return yid.http.post(`${prefix}/serviceprice/saveServcards?shopid=`+ params.shopid,params)
}

export function savespecials(params) {
    return yid.http.post(`${prefix}/serviceprice/savespecials?shopid=`+ params.shopid,params)
}

export function findEmployees(params) {
    return yid.http.get(`${prefix}/serviceinfo/employees?shopid=`+ params.shopid,{params})
}

export function findPositions(params) {
    return yid.http.get(`${prefix}/serviceinfo/positions?shopid=`+ params.shopid,{params})
}

export function findCardinfos(params) {
    return yid.http.get(`${prefix}/serviceinfo/cardinfos?shopid=`+ params.shopid,{params})
}
