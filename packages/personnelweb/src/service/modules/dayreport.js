...
export function servicerecordList(params) {
  return yid.http.get(
    `api-cashier/servicerecords/chain/admin/servicerecordList`,
    { params }
  )
}
...
export function packagerecordList(params) {
  return yid.http.get(
    `api-cashier/packagerecords/chain/admin/packageRecordList`,
    { params }
  )
}

export function cardRecordList(params) {
  return yid.http.get(`api-cashier/cardrecords/chain/admin/cardRecordsList`, {
    params
  })
}
