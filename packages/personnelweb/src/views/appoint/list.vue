    ...
    <div class="appoint-list">
        <el-form inline>
            ...
            <el-form-item label="门店：">
                <el-select clearable v-model.trim="model.shopid"  @clear="clearFormShop" @blur="clearFormShop" filterable :filter-method="filterShop" placeholder="请选择门店" style="width: 160px;">
        ...
        <yid-table pagination ref="table"  :data="tableData">
            ...
            <yid-table-column label="服务时长(min)" min-width="80" prop="hjtimes"></yid-table-column>
        ...
        <yid-dialog :title="searchDialog.title" :visible.sync="searchDialog.visible" width="850px">
            <el-form label-width="140px" ref="copyForm" :inline="true" class="demo-form-inline">
                ...
                <el-form-item label="服务时长：" prop="channel" label-width="100px">
                    <div style="width: 160px;">{{yybillhead.hjtimes}}min</div>
                </el-form-item><br/>
