      ...
      <el-collapse-transition>
          <div v-show="listShow">
            <div class="top">
                ...
                <el-button @click="showRegionShop" style="color: #00b6ff">查看机构下门店</el-button>
            </div>
            <br>
            <div class="middle">
                <el-tree
                ...
                <div v-if="!showRegion" class="table">
                    ...
                    <el-form ref="regionForm" :model="regionForm"  label-width="140px" >
                        <el-form-item label="机构名称：" prop="name" :rules="[{ required: true, message: '区域名称为空'}]">
                ...
                <div v-if="showRegion" class="table">
                    <yid-table :data="shopData" style="margin-top: 15px;">
                        ...
                        <yid-table-column label="操作" min-width="250" prop="content">
                            <template slot-scope="scope">
                                <el-link type="primary" @click="showDetailPage(scope.row)">详情</el-link>
                            </template>
                        </yid-table-column>
                    </yid-table>
                </div>
