    ...
    <div class="checkProducts">
        <el-row type="flex" justify="space-between">
            <el-form inline>
                    ...
                    <el-form-item label="支付时间：" prop="payTimeRange" label-width="100px">
                        <div class="block">
                            <el-date-picker
                                    :clearable = true
        ...
        <yid-table pagination ref="table"  style="margin-top: 15px;" @selection-change="handleSelectionChange">
            <yid-table-column label="支付类型"  prop="payname" width="100"></yid-table-column>
            <yid-table-column label="系统单号"  prop="billcode" width="200"></yid-table-column>
            <yid-table-column label="支付金额" prop="money" width="100"></yid-table-column>
            <yid-table-column label="未使用金额" prop="verMoney" width="100"></yid-table-column>
            ...
            <yid-table-column label="操作" min-width="80"  fixed="right">
                <template slot-scope="scope">
                    <el-button  type="text" @click="closedialogPay(scope.row)">选择</el-button>
                </template>
            </yid-table-column>
        </yid-table>
            </el-col>
