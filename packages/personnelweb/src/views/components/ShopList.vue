<template>
    ...
    <yid-dialog title="选择门店" :visible.sync="visible" @close="cancelSaveShop" width="1100px">
        ...
        <el-row>
            <el-col :span="14">
                <yid-table pagination ref="tableShop" style="margin-top: 10px;"Å
            ...
            <el-col :span="8" style="margin-left: 5px;">
                <yid-table ref="selectTableShop" style="margin-top: 10px;" :data="list">
                    ...
                    <yid-table-column label="操作" min-width="80">
                        <template slot-scope="scope">
                            <el-link type="primary" style="margin: 0 10px 0 10px;" @click="deleteShop(scope.row)">删除
                            </el-link>
                        </template>
                    </yid-table-column>
                </yid-table>
