    ...
    <div class="salaryRewardDetail">
        <el-form :model="ruleForm" ref="ruleForm" inline>
            ...
            <el-form-item label="门店：">
                <el-select clearable v-model.trim="ruleForm.shopid"  filterable :filter-method="filterShop"  @clear="clearFormShop" @blur="clearFormShop" placeholder="请选择门店" style="width: 160px;">
