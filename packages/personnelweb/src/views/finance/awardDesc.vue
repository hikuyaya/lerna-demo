  ...
  <div class="salaryRewardDetail">
    ...
    <yid-table style="width: 100%" :data="tableData">
      ...
      <el-table-column align="center" label="奖项">
        ...
        <el-table-column prop="zmoney" align="center" label="合计" width="80">
        </el-table-column>
      </el-table-column>
      <el-table-column align="center" label="扣罚项">
        <el-table-column
          ...
          <template slot-scope="scope">
            <span>{{
              scope.row.penaltys.find(e => penaltyList[i].id == e.padid)
                ? scope.row.penaltys.find(e => penaltyList[i].id == e.padid)
                    .value
                : 0
            }}</span>
        ...
        <el-table-column prop="fmoney" align="center" label="合计" width="80">
        </el-table-column>
      </el-table-column>
    </yid-table>
  </div>
  ...
  methods: {
    ...
    downExcel() {
      ...
      if (this.ruleForm.month instanceof Date)
        this.ruleForm.month = this.ruleForm.month.formatDate('yyyy-MM')
      download(
        yid.config.API.BASE + 'api-pers/awarddesc/excel/export',
        this.ruleForm
      )
    },
    getShopList(params) {
