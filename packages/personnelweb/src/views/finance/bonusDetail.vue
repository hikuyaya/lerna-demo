    ...
    <div class="member-review">
        <el-form ref="searchForm" inline :model="searchForm">
            <el-form-item label="选择门店：">
                <el-select clearable v-model="searchForm.shopid" filterable :filter-method="filterShop" placeholder="请选择" @clear="clearFormShop" @blur="clearFormShop">
            ...
            <el-form-item label="职务：">
                <el-select style="width: 100px" clearable v-model="searchForm.psid" filterable placeholder="请选择" @change="getPositionLevelList">
                    <el-option
            ...
            <el-form-item label="级别：">
                <el-select style="width: 100px"   filterable placeholder="请选择" v-model.trim="searchForm.pslid">
                    <el-option :key="item.id" :label="item.pslname" :value="item.id" v-for="item in positionLevelList"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="单号：">
                <el-input clearable v-model="searchForm.billcode" placeholder="单号"  style="width: 120px;"></el-input>
            </el-form-item>
        ...
        <yid-table pagination ref="table"  @expand-change="getDetail">
            ...
            <yid-table-column label="职位" min-width="120" prop="psname"></yid-table-column>
            ...
            <yid-table-column label="项目/商品" min-width="150" prop="sername"></yid-table-column>
            <yid-table-column label="日期" min-width="150" prop="billdate">
                <template slot-scope="scope">
                    {{$yid.util.formatDate(scope.row.billdate)}}
                </template>
            </yid-table-column>
            <yid-table-column label="业绩" min-width="100" prop="money"></yid-table-column>
            <yid-table-column label="提成" min-width="100" prop="royalty"></yid-table-column>
            <yid-table-column label="详情" width="100" type="expand" prop="billcode">
                <template slot-scope="scope">
                    <yid-table :data="scope.row.descs" class="children">
                        <yid-table-column prop="prnname" label="提成指标" ></yid-table-column>
                        ...
                        <yid-table-column prop="royaltyRate" label="提率" ></yid-table-column>
                        <yid-table-column prop="money" label="业绩" ></yid-table-column>
                        <yid-table-column prop="royalty" label="提成金额" ></yid-table-column>
                    </yid-table>
                </template>
            </yid-table-column>
        </yid-table>
