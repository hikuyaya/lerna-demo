    ...
    <div>
        <el-form ref="searchForm" inline :model="searchForm">
            ...
            <el-form-item label="门店：" label-width="100px">
                <el-select @clear="clearFormSelect('shop','shopid')" clearable v-model.trim="searchForm.shopid" filterable
                           :filter-method="dicList.shop.filterFunc" placeholder="请选择" style="width: 180px;">
            ...
            <el-form-item label="项目：" label-width="100px">
                <el-select @clear="clearFormSelect('dj','djid')" clearable v-model.trim="searchForm.djid" filterable
                           :filter-method="dicList.dj.filterFunc" placeholder="请选择" style="width: 220px;">
    ...
    export default {
        ...
        data(){
            return {
                ...
                dicList:{
                    shop:{all:[],filter:[],filterFunc: v => this.filterSelect(v,['shopname','shopcode'],"shop") },
                    dj:{all:[],filter:[],filterFunc: v => this.filterSelect(v,["code","name"],"dj") },
                },
            }
        },
        mounted() {
        ...
        methods: {
            ...
            filterSelect(v,colnums,tableName) {
                this.dicList[tableName].filter = this.dicList[tableName].all.filter(item => {
                    let flag = false
            ...
            getDicDjList(){
                service.finance.dicDjitem.listAll({"isDel":"0","isDkdj":"1"}).then(res => {
