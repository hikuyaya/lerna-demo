      ...
      <div v-show="!showList">
        ...
        <el-form
          ...
          <el-form-item
            ...
            prop="colnamenum"
            label-width="180px"
            :rules="[{ required: true, message: '报表列名不能为空' }]">
            NUMCOL<el-input
              type="number"
              v-model="djitemForm.colnamenum"
          ...
          <el-form-item
            ...
            prop="direction"
            label-width="180px"
            :rules="[{ required: true, message: '方向不能为空' }]">
            <el-select
              style="width: 200px"
              v-model="djitemForm.direction"
              clearable
              placeholder="请选择">
              <el-option
          ...
          <el-form-item
            ...
            prop="type"
            label-width="180px"
            :rules="[{ required: true, message: '计算类型不能为空' }]">
            <el-select
              style="width: 200px"
              v-model="djitemForm.type"
              clearable
              placeholder="请选择">
              <el-option
          ...
          <el-form-item
            ...
            prop="isDkdj"
            label-width="180px"
            :rules="[{ required: true, message: '是否代扣代缴不能为空' }]">
            <el-select
              style="width: 200px"
              v-model="djitemForm.isDkdj"
              clearable
              placeholder="请选择">
              <el-option
    ...
    checkColname() {
      if (!yid.util.isEmpty(this.djitemForm.colnamenum)) {
        ...
        service.finance.dicDjitem
          .checkColname({ id: this.djitemForm.id, colname: colname })
          .then(res => {
            if (res.resp_code == 200) {
              if (res.data.length > 0) {
