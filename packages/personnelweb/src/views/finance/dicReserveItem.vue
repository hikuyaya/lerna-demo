      ...
      <div v-show="!showList">
        ...
        <el-form
          ...
          <el-form-item
            ...
            <el-select
              style="width: 200px"
              v-model="reserveitemForm.status"
              clearable
              placeholder="请选择">
              <el-option
          ...
          <el-form-item
            ...
            <el-select
              style="width: 300px"
              multiple
              v-model="reserveitemForm.reservecodes"
              clearable
              placeholder="请选择">
              <el-option
