        ...
        yid.util.confirm(
          ...
          () => {
            if (billstatus == '1') {
              ...
              //调用审核单据接口
              service.finance.dormRentCont
                .auditBillForChain({ id: id, billcode: billcode })
                .then(res => {
                  if (res.resp_code == '200') {
