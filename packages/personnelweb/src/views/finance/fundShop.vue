            ...
            <el-col :span="8">
              ...
              <el-form-item
                ...
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="fundShopForm.initsreservfund"></el-input-number>
              </el-form-item>
              <el-form-item
                label="大额备用金是否检查营业款："
                prop="isCheck"
                :rules="[
                  { required: true, message: '请选择大额备用金是否检查营业款' }
                ]">
                <el-select
                  value-key="id"
                  placeholder="请选择"
                  v-model="fundShopForm.isCheck">
...
export default {
  ...
  methods: {
    ...
    getshopcode() {
      ...
      service.finance.fundShop
        .getFundShop({ shopcode: shopcode, shopType: shopPobj.type })
        .then(res => {
          if (res.resp_code == 200) {
