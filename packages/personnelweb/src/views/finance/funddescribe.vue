<template>
    ...
    <div class="salaryRewardDetail">
            ...
            <div v-show="showList">
                ...
                <el-form ref="searchForm" inline :model="searchForm">
                    <el-form-item label="项目编码：" prop="itemCode">
                        <el-input v-model="searchForm.ioitemCode"   style="width: 150px;"></el-input>
                    </el-form-item>
                    <el-form-item label="项目名称：" prop="itemCode">
                        <el-input v-model="searchForm.ioitemName"   style="width: 150px;"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="明细：" prop="describeinfo">
                        <el-input v-model="searchForm.describeinfo"   style="width: 150px;"></el-input>
                    </el-form-item>
                ...
                <yid-table pagination ref="table" :data="jobData" style="margin-top: 15px;" :row-class-name="$yid.util.getTableClass">
                    <yid-table-column label="项目编码" min-width="100" prop="ioitemCode"></yid-table-column>
                    <yid-table-column label="项目名称" min-width="150" prop="ioitemName"></yid-table-column>
                    ...
                    <yid-table-column label="明细" min-width="150" prop="describeinfo"></yid-table-column>
        ...
        <el-collapse-transition>
            ...
            <el-form ref="funddescribeForm" :model="funddescribeForm"  label-width="140px">
                <el-row :gutter="20">
                    <el-col :span="8">
                <el-form-item label="收支项目名称：" prop="ioitemCode"  :rules="[{ required: true, message: '收支项目名称为空'}]">
                    <el-select value-key="pid" placeholder="请选择" v-model="funddescribeForm.ioitemCode">
                        <el-option :key="item.id" :value="item.code" :label="item.name" v-for="item in ioitemDataAll"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="审批部门：" prop="orgcode" >
                    <el-select value-key="id" placeholder="请选择" v-model.trim="funddescribeForm.orgcode" >
                        <el-option label="财务部" value="0"></el-option>
                        <el-option label="信息部" value="1"></el-option>
                        <el-option label="美发部/美容部" value="2/3"></el-option>
                        <el-option label="工程部" value="4"></el-option>
                ...
                <el-form-item label="明细：" prop="describeinfo"  :rules="[{ required: true, message: '明细为空'}]">
                    <el-input  v-model="funddescribeForm.describeinfo" type="textarea"
        ...
        <yid-dialog :title="importDialog.title" :visible.sync="importDialog.visible" @close="importCancel" width="700px">
            <el-form :model="importDialog.model"  label-width="120px" ref="copyForm">
                ...
                <el-form-item label="下载导入模板：" align="left">
                    <el-link @click="downExcelTemplate" type="primary">支出项目关键字管理模板</el-link>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.excelConvertUrl = $yid.config.API.BASE + "api-finance/dicfunddescribe/convertSystem";
        ...
        methods: {
            ...
            getioitemListAll(){
                service.finance.funddescribe.ioitemAll({status:'1',type:'2'}).then(res=> {
            ...
            saveJob(){
                this.$refs['funddescribeForm'].validate((valid) => {
                    if(valid){
                        ...
                        service.finance.funddescribe.saveJob(this.funddescribeForm).then(res=> {
                            if(res.resp_code == 200) {
            ...
            downExcelTemplate(){
                download(yid.config.API.BASE + 'api-finance/dicfunddescribe/downSysTemplate', {})
            },
            saveImportIolimit(){
                if(this.importDialog.iolimits.length == 0){
                    yid.util.error("无导入数据");
                }else{
                    service.finance.funddescribe.saveSystem(this.importDialog.iolimits).then(res =>{
                        if(res.resp_code=="200"){
