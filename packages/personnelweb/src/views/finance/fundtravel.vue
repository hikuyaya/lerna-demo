    ...
    <el-collapse-transition>
      <div v-show="showList">
        ...
        <yid-table
          ...
          <yid-table-column label="事项内容" min-width="150" prop="itemnmae">
          </yid-table-column>
          <yid-table-column label="身份证姓名" min-width="150" prop="eename">
          </yid-table-column>
          <yid-table-column label="职位" min-width="150" prop="psname">
          </yid-table-column>
          <yid-table-column
            label="备注"
            min-width="250"
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item
                ...
                :rules="[{ required: true, message: '请选择是否报销' }]">
                <el-select
                  value-key="id"
                  placeholder="请选择"
                  v-model.trim="travelForm.status">
              ...
              <el-form-item
                label="事项内容："
                prop="itemnmae"
                :rules="[{ required: true, message: '事项内容为空' }]">
                <el-input
                  v-model="travelForm.itemnmae"
                  maxlength="32"
              ...
              <el-form-item
                label="职位："
                prop="psname"
                :rules="[{ required: true, message: '职位为空' }]">
                <el-input
                  v-model="travelForm.psname"
                  maxlength="32"
                  show-word-limit></el-input>
              </el-form-item>
              <el-form-item label="备注：" prop="memo">
                <el-input
                  v-model="travelForm.memo"
                  type="textarea"
...
export default {
  ...
  mounted() {
    this.excelConvertUrl =
      $yid.config.API.BASE + 'api-finance/fundtravel/convertSystem'
  ...
  methods: {
    ...
    downExcelTemplate() {
      download(
        yid.config.API.BASE + 'api-finance/fundtravel/downSysTemplate',
        {}
      )
    },
    saveImportIolimit() {
