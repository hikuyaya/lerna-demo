<template>
    <div>
        <el-row>
            ...
            <el-button v-show="isSp" @click="saveBillBefore" type="primary" style="margin-left: 60px">审批</el-button>
            ...
            <el-row style="margin-top: 15px">
                <el-col :span="8">
                    ...
                    <div style="display: flex;flex-wrap: wrap;margin-top: 15px; line-height: 36px">
                        ...
                        <el-select clearable filterable placeholder="请选择" style="width: 160px;  margin-right: 10px" :disabled ='!isSp' v-model.trim="billForm.tktype" @change="checkTktype">
                        ...
                        <el-select clearable filterable placeholder="请选择开户行" style="width: 150px"  :disabled ='!isShopext' v-model="billForm.bank" >
                            <el-option
                        ...
                        <el-input clearable placeholder="户名" :disabled ='!isShopext' v-model.trim="billForm.payee"  style="width: 100px; margin-right: 10px"></el-input>
                        <el-input clearable placeholder="账户" :disabled ='!isShopext' v-model.trim="billForm.bankno" style="width: 200px; margin-right: 10px"></el-input>
                    </div>
                </el-col>
                <el-col :span="8">
                    <div style="display: flex;flex-wrap: wrap;margin-top: 15px; line-height: 36px">
                    ...
                    <div style="display: flex;flex-wrap: wrap;margin-top: 15px; line-height: 36px">
                        ...
                        <el-select clearable filterable placeholder="请选择" :disabled ='!isSp'  style="width: 300px;" v-model.trim="billForm.tkway">
            ...
            <el-row :gutter="20" style="margin-top: 15px; border-top: 1px #f2f2f2 solid; padding-top: 15px">
                <el-col :span="8" style="overflow: hidden">
                    <div style="display: flex; flex-direction: column">
                        <div>
                            <label style="color: red; font-weight: bold; margin-right: 5px">*</label>核实退款属性：
                            <el-select clearable filterable placeholder="请选择" :disabled ='!isSp' style="width: 200px;" v-model.trim="billForm.hstkattr">
                                <el-option key="'tk_'+1" value="1" label="仅注销无退款"></el-option>
                                <el-option key="'tk_'+2" value="2" label="员工离职"></el-option>
                                <el-option key="'tk_'+3" value="3" label="个人原因"></el-option>
                                <el-option key="'tk_'+4" value="4" label="技术原因"></el-option>
                        ...
                        <div>
                            <label style="color: red; font-weight: bold; margin-right: 5px">*</label>核实退款原因：
                            <el-input
                                    type="textarea"
                                    :rows="5"
                                    :disabled ='!isSp'
    ...
    export default {
        ...
        methods:{
                ...
                if(!yid.util.isEmpty(billcode)){
                    yid.util.confirm("您确定要审核["+billcode+"]的单据?","","",()=>{
                        ...
                        if(status == '1'){
                            ...
                            //调用审核单据接口
                            service.finance.hyrefund.censor({id:id,billcode:billcode}).then(res=>{
                                if(res.resp_code=="200"){
            ...
            rejectBill(){
                ...
                //调用驳回单据接口
                service.finance.hyrefund.rejectBill({id:id,billcode:billcode,rejectmemo:rejectmemo}).then(res=>{
                    if(res.resp_code=="200"){
