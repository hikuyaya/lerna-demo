<template>
    <div class="hyrefundOffline">
            ...
            <div v-if="showList">
                ...
                <el-form inline style="margin-top: 20px" ref="searchForm" :model="searchForm">
                    ...
                    <el-form-item label="是否关店：" prop="isClose" label-width="100px">
                        <el-select clearable filterable placeholder="请选择" style="width: 120px;" v-model.trim="searchForm.isClose">
                            <el-option
        ...
        <el-collapse-transition>
            <div v-if="!showList">
                <hyrefundOlineDetailfh ref="detailPage" @onClose="closeDetailPage"></hyrefundOlineDetailfh>
            </div>
        </el-collapse-transition>
        <!--变更记录-->
