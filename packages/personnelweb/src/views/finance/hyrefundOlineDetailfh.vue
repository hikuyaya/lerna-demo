...
<div class="hyrefundOlineDetailfh">
    <el-row>
        ...
        <el-button @click="auditBill" v-show="!this.showButton" type="primary">复核</el-button>
        <el-button @click="cancelFhBill" v-show="this.billForm.status == '4'" type="primary">取消复核</el-button>
        ...
        <el-row>
            <el-col :span="8">
                ...
                <div>
                    ...
                    <el-select filterable placeholder="请选择" @change="getTkInfo" style="width: 120px;  margin-right: 10px; margin-bottom: 15px" :disabled ='true' v-model.trim="billForm.payType">
                        <el-option
                   ...
                   <!-- <el-input clearable placeholder="开户行" :disabled ='true' v-model.trim="billForm.bank"  style="width: 150px; margin-right: 10px; margin-bottom: 15px"></el-input>-->
                    <el-select :disabled="true" style="width: 150px" v-model="billForm.bank" placeholder="请选择开户行">
                        <el-option
                                clearable
                    ...
                    <el-input clearable placeholder="户名" :disabled ='true' v-model.trim="billForm.payee"  style="width: 100px; margin-right: 10px; margin-bottom: 15px"></el-input>
                    <el-input clearable placeholder="账户" :disabled ='true' oninput="value=value.replace(/[^\d]/g,'')" v-model.trim="billForm.bankno" style="width: 200px; margin-right: 10px; margin-bottom: 15px"></el-input>
                </div>
            </el-col>
            <el-col :span="8">
                ...
                <div  class="item">
                    ...
                    <el-select clearable filterable placeholder="请选择" :disabled ='true'  v-model.trim="billForm.tkType">
                        <el-option
        ...
        <el-row :gutter="20" style="margin-top: 15px; border-top: 1px #f2f2f2 solid; padding-top: 15px">
            <el-col :span="8" style="overflow: hidden">
                <div style="display: flex; flex-direction: column">
                    <div>
                        核实退款属性：
                        <el-select :disabled ='true' clearable filterable placeholder="请选择" style="width: 200px;" v-model.trim="billForm.hsAttr">
                            <el-option
                                    v-for="item in tkattrlist"
                                    :key="item.value"
                                    :label="item.label"
                ...
                if(!yid.util.isEmpty(billcode)){
                    yid.util.confirm("您确定要复核["+billcode+"]的单据?","","",()=>{
                        if(status == '1'){
                            ...
                            //调用审核单据接口
                            service.finance.xxtkRecords.auditBillfh({id:id,billcode:billcode}).then(res=>{
                                if(res.resp_code=="200"){
                ...
                if(!yid.util.isEmpty(billcode)){
                    yid.util.confirm("您确定要取消复核["+billcode+"]的单据?","","",()=>{
                        if(status != '4'){
                            ...
                            //调用取消复核单据接口
                            service.finance.xxtkRecords.cancelFhBill({id:id,billcode:billcode}).then(res=>{
                                if(res.resp_code=="200"){
