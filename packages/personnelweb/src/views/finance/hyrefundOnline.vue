    ...
    <div class="hyrefund">
        <el-collapse-transition>
            ...
            <div v-if="showList">
                ...
                <el-button @click="auditBillZeor" type="primary">自动审批零元退卡单</el-button>
        ...
        <el-collapse-transition>
            <div v-if="!showList"><hyrefundDetail  ref="detailPage" :visible.sync="showList"></hyrefundDetail></div>
        </el-collapse-transition>
                ...
                service.finance.hyrefund.list(params).then(res => {
                    if (res.resp_code == "200") {
                        if (res.data.length > 0) {
                            download($yid.config.API.BASE + "api-finance/cardtkhead/billExportForChainsp", this.searchFormReq);
                        } else {
