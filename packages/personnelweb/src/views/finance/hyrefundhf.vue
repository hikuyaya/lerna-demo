    ...
    <div class="hyrefund">
        <el-collapse-transition>
            <div v-if="showList">
                ...
                <yid-table pagination ref="table"  :data="tableData" width="2200" @selection-change="handleSelectionChange">
                    ...
                    <yid-table-column label="回访状态" min-width="120" prop="status">
                        <template slot-scope="scope">
                            {{scope.row.status==1?'未回访':scope.row.status==2?'回访中':scope.row.status==3?'已回访':scope.row.status==4?'免回访':scope.row.status==9?'已作废':''}}
                        </template>
                    </yid-table-column>
                    <yid-table-column label="会员姓名" min-width="120" prop="memname"></yid-table-column>
                    <yid-table-column label="手机号码" min-width="105" prop="mobile"></yid-table-column>
                    <yid-table-column label="退款时间" min-width="150" prop="checkdate"></yid-table-column>
                    <yid-table-column label="实退金额" min-width="80" prop="totalMoney"></yid-table-column>
                    <yid-table-column label="门店编码" min-width="80" prop="shopcode"></yid-table-column>
                    <yid-table-column label="门店名称" min-width="80" prop="shopname"></yid-table-column>
                    ...
                    <yid-table-column label="回访人" min-width="80" prop="hfBy"></yid-table-column>
                    <yid-table-column label="回访时间" min-width="150" prop="hfTime"></yid-table-column>
                ...
                service.finance.hyrefundhf.list(params).then(res=>{
                    if(res.resp_code=="200"){
                        if(res.data.length > 0){
                            download($yid.config.API.BASE + 'api-finance/cardtkhfhead/billHfExport', this.searchFormReq)
                        }else{
