            ...
            <div v-if="showList">
                ...
                <el-form inline style="margin-top: 20px">
                    ...
                    <el-form-item label="退款门店：">
                        <el-input  v-model.trim="searchForm.shopcode" placeholder=""  style="width: 150px;"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="回访人：">
                        <el-input  v-model.trim="searchForm.updatedBy" placeholder=""  style="width: 150px;"></el-input>
                    </el-form-item>

                    <el-form-item label="实退金额：" prop="totalMoney" label-width="100px">
                        <el-input clearable v-model="searchForm.totalMoneys"  style="width: 80px;"></el-input>
                        至
                        <el-input clearable v-model="searchForm.totalMoneye"  style="width: 80px;"></el-input>
                    </el-form-item>

                    <el-form-item label="退款类型：" prop="isprint" label-width="100px">
                        <el-select clearable v-model="searchForm.isprint" @change="changeShop" style="width: 180px">
                ...
                <yid-table pagination ref="table"  :data="tableData" width="2200" >
                    ...
                    <yid-table-column label="店名" min-width="80" prop="shopname"></yid-table-column>
                    <yid-table-column label="门店状态" min-width="120" prop="isClosed"></yid-table-column>
                    <yid-table-column label="退款总数" min-width="140" prop="tknum"></yid-table-column>
                    <yid-table-column label="0元退款例数" min-width="80" prop="zeronum"></yid-table-column>
                    <yid-table-column label="实际退款例数" min-width="120" prop="stnum"></yid-table-column>
                    <yid-table-column label="退为卡金例数" min-width="140" prop="cardnum"></yid-table-column>
                    <yid-table-column label="退款总金额" min-width="105" prop="totalmoney"></yid-table-column>
                    <yid-table-column label="退为卡金总金额" min-width="80" prop="cardmoney"></yid-table-column>
                    <yid-table-column label="关店原因退款金额" min-width="80" prop="closemoney"></yid-table-column>
                    <yid-table-column label="员工离职退款金额" min-width="150" prop="leavemoney"></yid-table-column>
                    <yid-table-column label="个人原因退款金额" min-width="80" prop="gerenmoney"></yid-table-column>
                    <yid-table-column label="技术原因退款金额" min-width="150" prop="jishumoney"></yid-table-column>
                    <yid-table-column label="消费原因退款金额" min-width="150" prop="xiaofeimoney"></yid-table-column>
                    <yid-table-column label="服务及接待退款金额" min-width="150" prop="fuwumoney"></yid-table-column>
                    <yid-table-column label="其他退款金额" min-width="150" prop="qitamoney"></yid-table-column>
                </yid-table>
            </div>
        </el-collapse-transition>
        <el-collapse-transition>
            <div v-if="!showList"><hyrefundHfDetail :visible.sync="showList" ref="detailPage"></hyrefundHfDetail></div>
        </el-collapse-transition>
        ...
        computed: {
            ...
            searchFormReq: function () {
                ...
                if(auditTimeRange != null && auditTimeRange.length>0){
                    ...
                    reqObj.sCreatedTimeStart =  this.getcreateDate(new Date(reqObj.sSTimeStart));
                }else{
                    reqObj.sSTimeStart = '';
                    reqObj.sSTimeEnd = '';
                ...
                service.finance.hyrefundhf.listtj(params).then(res => {
                    if (res.resp_code == "200") {
                        if (res.data.length > 0) {
                            download(
                                $yid.config.API.BASE +
                                "api-finance/cardtkhfhead/billExport",
                                this.searchFormReq
                            );
                        } else {
