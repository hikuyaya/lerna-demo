    ...
    <el-collapse-transition>
      <div v-show="showList">
        ...
        <yid-table ref="table" pagination style="width: 100%; margin-top: 10px">
          ...
          <yid-table-column prop="ioitemcode" label="项目编码" width="130">
          </yid-table-column>
          <yid-table-column prop="ioitemname" label="项目名称" width="130">
          </yid-table-column>
          <yid-table-column prop="payee" label="收款账户人" width="130">
          </yid-table-column>
          <yid-table-column prop="bankno" label="收款账户" width="130">
          </yid-table-column>
          <yid-table-column prop="bank" label="收款开户银行" width="130">
          </yid-table-column>
          <yid-table-column prop="branchbank" label="收款银行支行" width="130">
          </yid-table-column>
          <yid-table-column prop="updatedTime" label="更新时间" width="130">
          </yid-table-column>
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item
                ...
                <el-input
                  v-model="ioaccountForm.shopcode"
                  :disabled="isEdit"
                  style="width: 150px"
              ...
              <el-form-item
                ...
                <el-input
                  v-model="ioaccountForm.ioitemcode"
                  :disabled="isEdit"
                  style="width: 150px"
                  @change="getItemcode"></el-input>
              </el-form-item>
              <el-form-item
                label="收款账户人："
                prop="payee"
                :rules="[{ required: true, message: '收款账户人不能为空' }]"
                ><el-input
                  v-model="ioaccountForm.payee"
            ...
            <el-col :span="8">
              ...
              <el-form-item
                label="收款银行支行："
                prop="branchbank"
                :rules="[{ required: true, message: '收款银行支行不能为空' }]">
                <el-input
                  v-model="ioaccountForm.branchbank"
                  style="width: 200px"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
...
export default {
  ...
  mounted() {
    this.excelConvertUrl =
      $yid.config.API.BASE + 'api-finance/ioaccount/importExcel'
    this.getData('1')
    this.getShopList()
  ...
  methods: {
    ...
    validateNum() {
      this.ioaccountForm.bankno = this.ioaccountForm.bankno
        .replace(/\s/g, '')
        .replace(/[^\d]/g, '')
        .replace(/(\d{4})(?=\d)/g, '$1 ')
    }
