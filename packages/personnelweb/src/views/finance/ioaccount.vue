                ...
                <el-form ref="ioaccountForm" :model="ioaccountForm" style="margin-top: 16px" :rules="rules"
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            ...
                            <el-form-item label="收款账户人：" prop="payee"  :rules="[{ required: true, message: '收款账户人不能为空'}]"><el-input v-model="ioaccountForm.payee"
                                          style="width: 200px;"></el-input>
                            </el-form-item>
                            <el-form-item label="收款开户银行：" prop="bank" label-width="150px" :rules="[{ required: true, message: '开户银行不能为空'}]">
                                <el-select style="width: 200px" v-model="ioaccountForm.bank" placeholder="请选择">
                                    <el-option
                        ...
                        <el-col :span="8">
                            ...
                            <el-form-item label="收款账户：" prop="bankno" :rules="[{ required: true, message: '收款账户不能为空'}]">
                                <el-input v-model="ioaccountForm.bankno"
                                          style="width: 200px;" @blur="validateNum"></el-input>
                            </el-form-item>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.excelConvertUrl = $yid.config.API.BASE + "api-finance/ioaccount/importExcel";
            this.getData("1");
            this.getShopList();
        ...
        methods: {
            ...
            saveImportAccount() {
                ...
                if (this.mutiImportDialog.unionpays.length == 0) {
                    ...
                    service.finance.ioaccount.saveSystem(this.mutiImportDialog.unionpays).then(res => {
                        if (res.resp_code == 200) {
            ...
            validateNum () {
                this.ioaccountForm.bankno = this.ioaccountForm.bankno.replace(/\s/g, '').replace(/[^\d]/g, '').replace(/(\d{4})(?=\d)/g, '$1 ')
            },
        }
    }
</script>
