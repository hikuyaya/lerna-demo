        ...
        <el-collapse-transition>
            <div v-show="showList">
                ...
                <yid-table pagination ref="table" :data="jobData" style="margin-top: 15px;" :row-class-name="$yid.util.getTableClass">
                    <yid-table-column label="收支项目编码" min-width="100" prop="code"></yid-table-column>
                    <yid-table-column label="收支项目描述" min-width="150" prop="name"></yid-table-column>
                    ...
                    <yid-table-column label="父级收支项目" min-width="150" prop="pname">

                    </yid-table-column>
                    <yid-table-column label="预算期初金额" min-width="150" prop="budget">
...
-->
        ...
        <el-collapse-transition>
            ...
            <el-form ref="positionForm" :model="positionForm"  label-width="140px">
                <el-row :gutter="20">
                    <el-col :span="8">
                <el-form-item label="收支项目编码：" prop="code" :rules="[{ required: true, message: '收支项目编号为空'}]">
                    {{positionForm.code}}
                </el-form-item>
                <el-form-item label="收支项目类型：" prop="type" :rules="[{ required: true, message: '请选择收支项目类型'}]">
                    <el-select value-key="id" placeholder="请选择" v-model.trim="positionForm.type">
                        <el-option label="收入" value="1"></el-option>
                        <el-option label="支出" value="2"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="父级收支类型：" prop="pcode" >
                    <el-select value-key="pid" placeholder="请选择" v-model="positionForm.pcode"  :rules="[{ required: true, message: '请选择父级收支类型'}]">
                        <el-option :key="item.id" :value="item.code" :label="item.name" v-for="item in pioitems"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="收支项目名称：" prop="name"  :rules="[{ required: true, message: '收支项目名称为空'}]">
                    <el-input v-model="positionForm.name"  maxlength="32"
                              show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="预算期初金额：" prop="budget"  :rules="[{ required: true, message: '预算期初金额为空'}]">
                    <el-input-number  :precision="2" min="-1" v-model="positionForm.budget"></el-input-number>
                    限制金额负数只能为:-1,表示不作限制
                </el-form-item>

                <el-form-item label="状态：" prop="status" :rules="[{ required: true, message: '请选择状态'}]">
                    <el-select value-key="id" placeholder="请选择" v-model.trim="positionForm.status">
                        <el-option label="正常" value="1"></el-option>
                        <el-option label="停用" value="0"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注：" prop="memo" >
                    <el-input v-model="positionForm.memo" type="textarea"
                        ...
                        <el-collapse-transition>
                            <div v-show="transactionShow">
                                ...
                                <el-form ref="elsearchPForm" inline :model="searchPForm">
                                    ...
                                    <el-form-item label="项目描述：" prop="name">
                                        <el-input v-model="searchPForm.name"   style="width: 150px;"></el-input>
                                    </el-form-item>

                                    <el-form-item label="类型：" prop="type">
                                        <el-select v-model="searchPForm.type" clearable placeholder="请选择">
                                            <el-option label="收入" value="1"></el-option>
                                            <el-option label="支出" value="2"></el-option>
                                        </el-select>
                                    </el-form-item>
                                    <el-form-item label="状态：" prop="status">
                                        <el-select v-model="searchPForm.status" clearable placeholder="请选择">
                                            <el-option label="正常" value="1"></el-option>
                                            <el-option label="停用" value="0"></el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <yid-table pagination ref="elTable" :data="jobData" style="margin-top: 15px;" :row-class-name="$yid.util.getTableClass">
                                    <yid-table-column label="收支项目编码" min-width="100" prop="code"></yid-table-column>
                                    <yid-table-column label="收支项目描述" min-width="150" prop="name"></yid-table-column>
                                    <yid-table-column label="收支项目类型" min-width="150" prop="type">
                                        <template slot-scope="scope">
                                ...
                                <el-form ref="elPioitemForm" :model="pioitem"  label-width="140px">
                                    <el-row :gutter="20">
                                        <el-col :span="8">
                                            ...
                                            <el-form-item label="收支项目类型：" prop="type" :rules="[{ required: true, message: '请选择收支项目类型'}]">
                                                <el-select value-key="id" placeholder="请选择" v-model.trim="pioitem.type">
                                                    <el-option label="收入" value="1"></el-option>
                                                    <el-option label="支出" value="2"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            ...
                                            <el-form-item label="收支项目名称：" prop="name"  :rules="[{ required: true, message: '收支项目名称为空'}]">
                                                <el-input v-model="pioitem.name"  maxlength="32"
                                                          show-word-limit></el-input>
                                            </el-form-item>

                                            <el-form-item label="状态：" prop="status" :rules="[{ required: true, message: '请选择状态'}]">
                                                <el-select value-key="id" placeholder="请选择" v-model.trim="pioitem.status">
                                                    <el-option label="正常" value="1"></el-option>
                                                    <el-option label="停用" value="0"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="备注：" prop="memo" >
                                                <el-input v-model="pioitem.memo" type="textarea"
                                                          :autosize="{ minRows: 4, maxRows: 8}" maxlength="1000"
                                                          show-word-limit></el-input>
                                            </el-form-item>
                                        </el-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            pioitems: function () {
                if (this.positionForm.type=="1")
                    return this.pilist;
                if (this.positionForm.type=="2")
                    return this.polist;
                return [];
            }
        },
        ...
        methods: {
            ...
            backP(tag){
                this.pioitem = {id:"",code:"",name:"",type:"",status:"",memo:""};
                if(tag){
                    $yid.service.finance.pioitem.nextCode().then(res=> {
                        if(res.resp_code == 200)
                            this.pioitem.code=res.data;
                        this.transactionShow = !this.transactionShow;
                    });
                }else{
                    this.transactionShow = !this.transactionShow;
