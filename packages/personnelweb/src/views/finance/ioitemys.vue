      ...
      <div v-show="showList">
        ...
        <yid-table
          ...
          <yid-table-column
            label="收支项目编码"
            min-width="150"
            prop="iocode"></yid-table-column>
          <yid-table-column
            label="收支项目描述"
            min-width="150"
            prop="ioname"></yid-table-column>
          <yid-table-column label="年" min-width="150" prop="years">
          </yid-table-column>
          <yid-table-column label="年金额" min-width="150" prop="yearsmoney">
          </yid-table-column>
          <yid-table-column label="一季度金额" min-width="150" prop="onesmoney">
          </yid-table-column>
          <yid-table-column label="二季度金额" min-width="150" prop="twosmoney">
          </yid-table-column>
          <yid-table-column
            label="三季度金额"
            min-width="150"
          ...
          <yid-table-column
            label="四季度金额"
            min-width="150"
            prop="foursmoney"></yid-table-column>
          <yid-table-column
            label="更新人"
            min-width="150"
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item
                label="年："
                prop="years"
                :rules="[{ required: true, message: '年为空' }]">
                <div class="block">
                  <el-date-picker
                    :clearable="true"
                    style="width: 150px"
              ...
              <el-form-item
                ...
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="ioitemysForm.yearsmoney"></el-input-number>
              </el-form-item>
              <el-form-item
                label="一季度金额："
                prop="onesmoney"
                :rules="[{ required: true, message: '一季度金额为空' }]">
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="ioitemysForm.onesmoney"></el-input-number>
              </el-form-item>
              <el-form-item
                label="二季度金额："
                prop="twosmoney"
                :rules="[{ required: true, message: '二季度金额为空' }]">
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="ioitemysForm.twosmoney"></el-input-number>
              </el-form-item>
              <el-form-item
                label="三季度金额："
                prop="threesmoney"
                :rules="[{ required: true, message: '三季度金额为空' }]">
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="ioitemysForm.threesmoney"></el-input-number>
              </el-form-item>
              <el-form-item
                label="四季度金额："
                prop="foursmoney"
                :rules="[{ required: true, message: '四季度金额为空' }]">
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="ioitemysForm.foursmoney"></el-input-number>
              </el-form-item>
              <el-form-item label="备注：" prop="memo">
                <el-input
                  v-model="ioitemysForm.memo"
                  type="textarea"
...
export default {
  ...
  mounted() {
    this.excelConvertUrl =
      $yid.config.API.BASE + 'api-finance/iolimitys/convertSystem'
  ...
  methods: {
    ...
    downExcelTemplate() {
      download(
        yid.config.API.BASE + 'api-finance/iolimitys/downSysTemplate',
        {}
      )
    },
    saveImportIolimit() {
