      ...
      <div v-show="showList">
        ...
        <yid-table
          ...
          <yid-table-column
            label="年月"
            min-width="100"
            prop="yearmonth"></yid-table-column>
      ...
      <div v-show="!showList">
        ...
        <el-form
          ...
          <el-form-item
            label="年月："
            prop="yearmonth"
            :rules="[{ required: true, message: '年月为空' }]">
            <el-date-picker
...
export default {
  ...
  methods: {
    ...
    getMonthlock() {
      service.finance.monthLock
        .monthLockAll({ yearmonth: this.monthlockForm.yearmonth })
        .then(res => {
