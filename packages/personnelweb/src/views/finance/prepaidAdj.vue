      ...
      <div v-show="showList">
        ...
        <el-form :model="searchForm" inline ref="searchForm">
          ...
          <el-form-item label="现门店编码：" prop="adjShopcode">
            <el-input
              v-model="searchForm.adjShopcode"
              clearable
              style="width: 150px"></el-input>
          </el-form-item>
        ...
        <yid-table
          ...
          <yid-table-column
            label="商户订单号"
            min-width="150"
            prop="paymentNo"></yid-table-column>
          <yid-table-column
            label="系统订单号"
            min-width="150"
          ...
          <yid-table-column
            label="调整门店编码"
            min-width="200"
            prop="adjShopcode"></yid-table-column>
          <yid-table-column
            label="调整门店名称"
            min-width="150"
            prop="adjShopname"></yid-table-column>
          <yid-table-column
            label="调整时间"
            min-width="150"
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item
                label="系统订单号："
                prop="billcode"
                :rules="[{ required: true, message: '系统订单号为空' }]">
                <el-input
                  v-model="prepaidAdjForm.billcode"
                  @change="getprepaid"></el-input>
              </el-form-item>
              <el-form-item label="原门店编码：" prop="shopcode">
              ...
              <el-form-item
                label="调整门店编码："
                prop="adjShopcode"
                :rules="[{ required: true, message: '调整门店编码为空' }]">
                <el-input
                  v-model="prepaidAdjForm.adjShopcode"
...
export default {
  ...
  methods: {
    ...
    getprepaid() {
      ...
      service.cashier.prepaidorder
        .queryByno({
          billcode: this.prepaidAdjForm.billcode
        })
        .then(res => {
