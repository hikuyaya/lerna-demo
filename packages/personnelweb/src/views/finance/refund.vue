<template>
  <div class="dept">
    ...
    <yid-dialog
      ...
      :visible.sync="memDialog.visible"
      @close="closeDialog(1)"
      width="600px">
      <el-row>
      ...
      <div class="meminfo">
                ...
                <yid-table-column prop="tkNum" label="退款数量" min-width="100">
                  <template slot-scope="scope">
                    <el-input
                      type="number"
                      min="0"
                      v-model="scope.row.tkNum"></el-input>
                  </template>
                </yid-table-column>
                <yid-table-column
                  prop="tkje"
        ...
        <yid-table
          ...
          <yid-table-column label="开卡/续卡金额" min-width="120">
            <template slot-scope="scope">
              <div>
                <el-button @click="lookupLog(scope.row.cardid)">查看</el-button>
              </div>
            </template>
          </yid-table-column>
          <yid-table-column
        ...
        <el-rol>
          <el-col :span="3" :offset="6"
            ><el-button type="primary" @click="back()">返回</el-button></el-col
          >
          <el-col :span="3"
  ...
  methods: {
    ...
    seachMember() {
      ...
      service.member.refund
        .getMember({ mobile: this.memDialog.mobile })
        .then(res => {
