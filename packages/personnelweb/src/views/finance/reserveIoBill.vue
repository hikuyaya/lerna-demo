    ...
    <div class="reserveIoBill">
            ...
            <div v-show="showList">
                ...
                <el-form ref="searchForm" inline :model="searchForm">
                    ...
                    <el-form-item label="单据状态：" prop="status">
                        <el-select clearable style="width: 100px" v-model="searchForm.status" placeholder="请选择">
                            <el-option
                    ...
                    <el-form-item label="支出项目：" prop="riid" label-width="100px">
                        <el-select style="width: 150px" v-model="searchForm.riid" clearable placeholder="请选择">
                            <el-option
                ...
                <yid-table ref="table" pagination style="width: 100%;margin-top: 10px;" @selection-change="handleSelectionChange">
                    ...
                    <yid-table-column prop="riname" label="支出项目" width="150"></yid-table-column>
                    <yid-table-column prop="money" label="支出金额" width="80"></yid-table-column>
        ...
        <el-collapse-transition>
            <div v-show="!showList" >
                ...
                <el-button style="margin-left:25px;" v-print="printObj"  @click="handleprint(printObj)">打印</el-button>
                <div ref="printId" id="printId" cellspacing="0" cellpadding="0" border="0">
                    <el-form ref="billForm" :model="billForm" style="margin-top: 16px" :rules="rules" label-width="100px" label-position="right">
                        <div class="container">
                            <div style="width: 250px;display: inline-block;">单&nbsp;据&nbsp;编&nbsp;码：{{billForm.billcode}}</div>
                        ...
                        <div class="container">
                            <div style="width: 250px;display: inline-block;">用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：
                                <el-select disabled="disabled" style="width: 120px" v-model="billForm.riid" clearable placeholder="请选择">
                                    <el-option
                                            v-for="item in reserveIoitemList"
                                            :key="item.id"
                                            :label="item.name"
                            ...
                            <div style="width: 250px;display: inline-block;">支出合计：{{billForm.money}}</div>
                            <div style="display: inline-block;">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：{{billForm.memo}}</div>
                        </div>
                        <div class="container">
                            ...
                            <div style="display: inline-block;">银行账号：{{billForm.bankno}}</div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="15">
                            <yid-table ref="showTable" style="margin-top: 10px;" :data="billForm.details">
                                <yid-table-column label="预留款类型" min-width="100" prop="rmcode">
                                    <template slot-scope="scope">
                                        <el-select disabled="disabled" v-model.trim="scope.row.rmcode" placeholder="请选择" style="width: 150px;">
                                            <el-option :key="item.id" :label="item.name" :value="item.code" v-for="item in reserveList"></el-option>
                                        </el-select>
                                    </template>
                                </yid-table-column>
                                <yid-table-column label="支出金额" min-width="150px" prop="money"></yid-table-column>
                            </yid-table>
                        </el-col>
                        <el-col :span="5">
                            <yid-table ref="shopReserveTable" style="margin-top: 10px;" :data="this.shopReserveMoneys">
                                <yid-table-column label="款项" min-width="120px" prop="reservename"></yid-table-column>
                                <yid-table-column label="余额" min-width="100px" prop="money"></yid-table-column>
                            </yid-table>
                        </el-col>
                    </el-row>
                </div>
