    ...
    <div class="salaryRewardDetail">
        <el-form :model="ruleForm" ref="ruleForm" inline>
            ...
            <el-form-item label="门店：">
                <el-select clearable v-model.trim="ruleForm.shopid"  @clear="clearFormShop" @blur="clearFormShop" filterable :filter-method="filterShop" placeholder="请选择门店" style="width: 160px;">
