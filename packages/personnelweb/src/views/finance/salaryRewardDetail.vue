        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-input
              ...
              min="0"
              v-model="
                scope.row.awards[getAwardid(scope.row.awards, item.id)].value
              "></el-input>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-input
              ...
              min="0"
              v-model="
                scope.row.penaltys[getPenaltyid(scope.row.penaltys, item.id)]
                  .value
              "></el-input>
  ...
  methods: {
    ...
    saveAwardDesc() {
      ...
      if (this.tableData.length > 0) {
        service.pers.awardDesc
          .batchUpate({ awardDescVOList: this.tableData })
          .then(res => {
            if (res.resp_code == 200) {
      ...
      if (this.mutiImportDialog.importData.length == 0) {
        ...
        service.pers.awardDesc
          .batchImport({
            ...
            maps: this.mutiImportDialog.importData
          })
          .then(res => {
            if (res.resp_code == 200) {
    ...
    downMb() {
      download(
        yid.config.API.BASE + 'api-pers/awarddesc/excel/exportMb',
        this.ruleForm
      )
    },
