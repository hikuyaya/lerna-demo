        ...
        <el-collapse-transition>
            <div v-show="showList">
                ...
                <yid-table pagination ref="table" :data="jobData" style="margin-top: 15px;" :row-class-name="$yid.util.getTableClass">
                    ...
                    <yid-table-column label="财务片区" min-width="150" prop="faname"></yid-table-column>
                    <yid-table-column label="管理费系数" min-width="150" prop="feeRatio"></yid-table-column>
                    ...
                    <yid-table-column label="关店清零日期" min-width="150" prop="closedDate">
                        <template slot-scope="scope">
                            {{$yid.util.formatDate(scope.row.closedDate)}}
                        </template>
                    </yid-table-column>
                    <yid-table-column label="财务公司类型" min-width="150" prop="ftypename">
                    </yid-table-column>
                ...
                <el-row :gutter="24">
                    <el-col :span="6">
                        <el-form-item label="门店编码：" prop="shopcode" :rules="[{ required: true, message: '门店编码为空'}]">
                            <el-input style="width: 150px" v-model="shopExtForm.shopcode"  @change="getshopcode"></el-input>
                        </el-form-item>
                        <el-form-item label="财务片区：" prop="" >
                            <el-select style="width: 150px" value-key="pid" placeholder="请选择" v-model="shopExtForm.facode">
                        ...
                        <el-form-item label="收款人姓名：" prop="payee"  >
                            <el-input style="width: 150px" v-model="shopExtForm.payee"></el-input>
                        </el-form-item>

                        <el-form-item label="收款人姓名(对公)：" prop="pubPayee">
                            <el-input style="width: 160px" v-model="shopExtForm.pubPayee"></el-input>
                        </el-form-item>
                    ...
                    <el-col :span="6">
                        ...
                        <el-form-item label="开户账号：" prop="bankno"  >
                            <el-input style="width: 180px" v-model="shopExtForm.bankno" @change="validateNum"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="开户账号(对公)：" prop="pubBankno">
                            <el-input style="width: 160px" v-model="shopExtForm.pubBankno"></el-input>
                        </el-form-item>


                        <el-form-item label="管理费系数：" prop="feeRatio">
                            <el-input-number v-model="shopExtForm.feeRatio"  :min="0" :max="100" ></el-input-number>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    <el-form-item label="门店类型：" prop="shopType"  >
                        <el-select  style="width: 150px" value-key="id" placeholder="请选择" v-model.trim="shopExtForm.shopType" disabled>
                        ...
                        <el-form-item label="是否关店清零：" prop="isClosed"  >
                            ...
                            <el-select style="width: 150px" value-key="id" placeholder="请选择" v-model.trim="shopExtForm.isClosed">
                        ...
                        <el-form-item label="开户行：" prop="bank" label-width="160px"  >
                            <el-select style="width: 150px" v-model="shopExtForm.bank" placeholder="请选择">
                                <el-option
                        ...
                        <el-form-item label="开户行(对公)：" prop="pubBank" label-width="160px">
                            <el-select style="width: 150px" v-model="shopExtForm.pubBank" placeholder="请选择">
                                <el-option
                                        v-for="item in bankList"
                                        :key="item.id"
                                        :label="item.bank"
                    ...
                    <el-col :span="6">
                        ...
                        <el-form-item label="支行名称：" prop="branchbank"  >
                            <el-input style="width: 180px" v-model="shopExtForm.branchbank"></el-input>
                        </el-form-item>


                        <el-form-item label="支行名称(对公)：" prop="pubBranchbank">
                            <el-input style="width: 160px" v-model="shopExtForm.pubBranchbank"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
    ...
    export default {
        ...
        methods: {
            ...
            getshopcode() {
               ...
               // console.log(shopPobj.shopname+":"+shopPobj.shopcode);
                if(yid.util.isEmpty(shopPobj)){
                    ...
                    service.finance.shopExt.getShopExtShow({shopcode:shopcode}).then(res => {
            ...
            saveJob(){
                this.$refs['shopExtForm'].validate((valid) => {
                    if(valid){
                        ...
                        if(isClosed =='1' &&  !yid.util.isEmpty(openDate) && closeDate<=openDate){
            ...
            validateNum () {
                ...
                this.shopExtForm.bankno = this.shopExtForm.bankno.replace(/\s/g, '').replace(/[^\d]/g, '').replace(/(\d{4})(?=\d)/g, '$1 ')
            },
