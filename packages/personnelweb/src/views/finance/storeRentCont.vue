  ...
  <div class="storeRentCont">
    ...
    <el-collapse-transition>
      <div v-show="!showList">
        ...
        <el-form
          ref="storeRentContForm"
          :model="storeRentContForm"
          ...
          <el-form-item label="合同编码：" prop="code" label-width="150px">
            <el-input
              v-model="storeRentContForm.code"
              placeholder="自动生成"
              disabled="disabled"
          ...
          <el-form-item
            ...
            <el-input
              v-model="storeRentContForm.shopcode"
              clearable
              placeholder="门店编码"
              :disabled="!editCode"
              @blur="checkShopcode"
          ...
          <el-form-item
            ...
            <el-input
              v-model="storeRentContForm.shopname"
              placeholder="门店名称"
              disabled="disabled"
              style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item
            ...
            prop="dlcode"
            label-width="150px"
            :rules="[{ required: true, message: '房东编码不能为空' }]">
            <el-input
              v-model="storeRentContForm.dlcode"
              clearable
              placeholder="编码"
              disabled="disabled"
              style="width: 200px"></el-input
          ...
          <el-form-item
            ...
            <el-input
              v-model="storeRentContForm.dlname"
              placeholder="名称"
              disabled="disabled"
              style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item
            ...
            prop="startdateStr"
            label-width="150px"
            :rules="[{ required: true, message: '开始年月日不能为空' }]">
            <el-date-picker
              clearable
              style="width: 200px"
              v-model="storeRentContForm.startdateStr"
          ...
          <el-form-item
            ...
            prop="enddateStr"
            label-width="150px"
            :rules="[{ required: true, message: '结束年月日不能为空' }]">
            <el-date-picker
              clearable
              style="width: 200px"
              v-model="storeRentContForm.enddateStr"
              value-format="yyyy-MM-dd"
              type="date"
              placeholder="选择日期"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="备注：" prop="name" label-width="150px">
            <el-input
              v-model="storeRentContForm.memo"
              type="textarea"
              :rows="2"
    ...
    <yid-dialog
      :title="dlDialog.title"
      :visible.sync="dlDialog.visible"
      @close="dlCancel"
      width="900px">
  ...
  methods: {
    ...
    checkShopcode() {
      ...
      if (!yid.util.isEmpty(shopcode)) {
        ...
        service.chain.shop
          .shopList({ shopcode: shopcode, isDel: '0' })
          .then(res => {
            if (res.resp_code == 200) {
    ...
    saveAction() {
      this.$refs['storeRentContForm'].validate(valid => {
        if (valid) {
          ...
          service.finance.storeRentCont
            .saveAction(this.storeRentContForm)
            .then(res => {
              if (res.resp_code == 200) {
