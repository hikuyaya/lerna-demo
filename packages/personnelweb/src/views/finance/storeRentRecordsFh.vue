        ...
        <el-collapse-transition>
            <div v-show="showList">
                ...
                <yid-table ref="table" pagination style="width: 100%;margin-top: 10px;" @selection-change="handleSelectionChange">
                    ...
                    <yid-table-column prop="totalmoney" label="金额" width="80"></yid-table-column>
                ...
                <div ref="printId" id="printId" cellspacing="0" cellpadding="0" border="0">
                    <el-form ref="billForm" :model="billForm" style="margin-top: 16px" :rules="rules" label-width="100px" label-position="right">
                        ...
                        <div class="container" style="color: green">
                            <div style="width: 250px;display: inline-block;">房东编码：{{billForm.dcode}}</div>
                        ...
                        <div class="container" style="color: green">
                            ...
                            <div style="width: 250px;display: inline-block;">开户行：{{billForm.bank}}</div>
                            <div style="width: 210px;display: inline-block;">合同类型：
                        ...
                        <el-col :span="12">
                            <el-row :gutter="24">
                                <el-col :span="10">
                                    ...
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">总额：
                                        <el-input type="number" v-model="billForm.totalmoney" placeholder="总额"
                                                  style="width: 150px;" disabled="disabled"></el-input>
                                    </div>
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">营业款：
                                        <el-input type="number" v-model="billForm.yyk" placeholder="营业款"
                                                   style="width: 150px;"  disabled="disabled"></el-input>
                                    </div>
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">预留房租：
                                        <el-input type="number" v-model="billForm.ylfz" placeholder="预留房租"
                                                   style="width: 150px;"  disabled="disabled"></el-input>
                                    </div>
                                ...
                                <el-col :span="10">
                                    ...
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">汇款方式：
                                        <el-select style="width: 150px" v-model="billForm.remittype" placeholder="请选择" disabled="disabled">
                                            <el-option
                                    ...
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">风险金或其他借款：
                                        <el-input type="number" v-model="billForm.otherOne" placeholder="风险金或其他借款"
                                                   style="width: 100px;"  disabled="disabled"></el-input>
                                    </div>
                                    <div style="width: 250px;display: inline-block;margin-top: 10px;color: red">预留其他：
                                        <el-input type="number" v-model="billForm.ylqt" placeholder="预留其他"
                                                  style="width: 150px;"  disabled="disabled"></el-input>
                                    </div>
                                </el-col>
                            </el-row>
    ...
    export default {
        ...
        methods: {
          printDom(){
                ...
                service.finance.storeRentRecords.billListForChain(params).then(res=>{
                    if(res.resp_code=="200"){
                        if(res.data.length > 0){
                            download($yid.config.API.BASE + 'api-finance/storerentrecords/billExportForChain', this.searchFormReq)
                        }else{
            ...
            changeSumType(){
                if(!yid.util.isEmpty(this.billForm.billcode)){
                    service.finance.storeRentRecords.changeSumType(this.billForm).then(res=>{
                        if(res.resp_code=="200"){
            ...
            deleteBill(){
                if(!yid.util.isEmpty(this.billForm.billcode)){
                    yid.util.confirm("您确定要删除["+this.billForm.billcode+"]的单据?","","",()=>{
                        service.finance.storeRentRecords.deleteBill(this.billForm).then(res =>{
                            if(res.resp_code=="200"){
                ...
                if(!yid.util.isEmpty(billcode)){
                    yid.util.confirm("您确定要审核["+billcode+"]的单据?","","",()=>{
                        if(status == '1'){
                            ...
                            //调用审核单据接口
                            service.finance.storeRentRecords.auditBill({id:id,billcode:billcode,memo:memo}).then(res=>{
                                if(res.resp_code=="200"){
            ...
            cancelAuditBill(){
                ...
                if(billids.length > 0){
                    ...
                    yid.util.confirm("您确定要取消审批所选的单据?","","",()=>{
                        //调用取消审核单据接口
                        service.finance.storeRentRecords.cancelAuditBill({billids:billids}).then(res=>{
                            if(res.resp_code=="200"){
