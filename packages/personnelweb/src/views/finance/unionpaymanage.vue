  ...
  <div class="salaryRewardDetail">
      ...
      <div v-show="showList">
        ...
        <el-form ref="searchForm" inline :model="searchForm">
          ...
          <el-form-item label="终端号：" prop="terminalcode">
            <el-input
              v-model="searchForm.terminalcode"
              style="width: 150px"></el-input>
          </el-form-item>
          <el-form-item label="限制金额：" prop="limitMoney">
            <el-input
              v-model="searchForm.limitMoney"
              style="width: 100px"></el-input>
          </el-form-item>
          <el-form-item label="">
        ...
        <yid-table ref="table" pagination style="width: 100%; margin-top: 10px">
          <yid-table-column prop="shopcode" label="店号" width="90">
          </yid-table-column>
          <yid-table-column prop="shopname" label="店名" width="120">
          </yid-table-column>
          <yid-table-column
            prop="bcMerchantCode"
            label="对私B扫C商户号"
          ...
          <yid-table-column
            prop="pubCbMerchantCode"
            label="对公C扫B商户号"
            width="130">
          </yid-table-column>
          <yid-table-column
            prop="pubCbTerminalCode"
            label="对公C扫B终端号"
            width="130">
          </yid-table-column>
          <yid-table-column
    ...
    <el-collapse-transition>
      <div v-show="!showList">
        ...
        <el-form
          ref="uplshopaccountForm"
          :model="uplshopaccountForm"
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item
                label="门店店号："
                prop="shopcode"
                :rules="[{ required: true, message: '门店店号不能为空' }]">
                <el-input
                  v-model="uplshopaccountForm.shopcode"
                  style="width: 150px"
              ...
              <el-form-item label="对私B扫C商户号：" prop="bcMerchantCode">
                <el-input
                  v-model="uplshopaccountForm.bcMerchantCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              <el-form-item label="对私B扫C终端号：" prop="bcTerminalCode">
                <el-input
                  v-model="uplshopaccountForm.bcTerminalCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              <el-form-item label="对私C扫B商户号：" prop="cbMerchantCode">
                <el-input
                  v-model="uplshopaccountForm.cbMerchantCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              <el-form-item label="对私C扫B终端号：" prop="cbTerminalCode">
                <el-input
                  v-model="uplshopaccountForm.cbTerminalCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              ...
              <el-form-item label="对公限金额：" prop="limitMoney">
                <el-input-number
                  :precision="2"
                  :min="0"
                  v-model="uplshopaccountForm.limitMoney"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              ...
              <el-form-item label="对公B扫C商户号：" prop="pubBcMerchantCode">
                <el-input
                  v-model="uplshopaccountForm.pubBcMerchantCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              ...
              <el-form-item
                ...
                :rules="[{ message: '不能为空' }]">
                <el-input
                  v-model="uplshopaccountForm.pubBcTerminalCode"
                  style="width: 150px"></el-input>
              </el-form-item>

              <el-form-item label="对公C扫B商户号：" prop="pubCbMerchantCode">
                <el-input
                  v-model="uplshopaccountForm.pubCbMerchantCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              ...
              <el-form-item
                ...
                :rules="[{ message: '不能为空' }]">
                <el-input
                  v-model="uplshopaccountForm.pubCbTerminalCode"
                  style="width: 150px"></el-input>
              </el-form-item>
              <el-form-item label="对私C扫B二维码：">
                <el-button type="primary" @click="getUnionQr"
                  >点击生成</el-button
                >
                <div v-show="showQrcode">
                  <VueQrcode :value="this.qrcode" :size="250" />
                </div>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    <yid-dialog
      ...
      <el-form
        ...
        <p>操作提示</p>
        <p>1、点击链接：下载门店对公限制金额模板；</p>
        <p>2、下载完成并保存文件，然后打开文件并输入对公限制金额；</p>
...
export default {
  ...
  mounted() {
    this.excelConvertUrl =
      $yid.config.API.BASE + 'api-finance/uplshopaccount/importExcel'
    this.getData('1')
    this.getShopList()
  },
  filters: {
  ...
  methods: {
    ...
    save() {
      ...
      this.$refs['uplshopaccountForm'].validate(valid => {
        if (valid) {
          ...
          service.finance.unionpaymanage
            .save(that.uplshopaccountForm)
            .then(res => {
    ...
    getshopcode() {
      ...
      service.finance.unionpaymanage
        .getShopcodeAccountShow({ shopcode: shopcode })
        .then(res => {
          if (res.resp_code == 200) {
    ...
    downExcelTemplate() {
      download(
        yid.config.API.BASE + 'api-finance/uplshopaccount/excelTemplate',
        {}
      )
    },
    ...
    saveImportAccount() {
      if (this.mutiImportDialog.unionpays.length == 0) {
        ...
        service.finance.unionpaymanage
          .saveSystem(this.mutiImportDialog.unionpays)
          .then(res => {
            if (res.resp_code == 200) {
    ...
    importBill() {
      ...
      service.finance.unionpaymanage.list(params).then(res => {
        if (res.resp_code == '200') {
          if (res.data.length > 0) {
            download(
              $yid.config.API.BASE +
                'api-finance/uplshopaccount/expRecordsList',
              this.searchForm
            )
          } else {
