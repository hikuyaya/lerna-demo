    ...
    <div class="salaryRewardDetail">
            ...
            <div v-show="showList">
                ...
                <yid-table ref="table" pagination style="width: 100%;margin-top: 10px;">
                    ...
                    <yid-table-column
                            ...
                            label="对公C扫B商户号" width="130">
                    </yid-table-column>
                    <yid-table-column
                            prop="pubCbTerminalCode"
                            label="对公C扫B终端号" width="130">
                    </yid-table-column>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            ...
                            <el-form-item label="对公限金额：" prop="limitMoney">
                                ...
                                <el-input-number :precision="2" :min="0" v-model="uplshopaccountForm.limitMoney"></el-input-number>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
        ...
        <yid-dialog :title="mutiImportDialog.title" :visible.sync="mutiImportDialog.visible" @close="importCancel"
            ...
            <el-form :model="mutiImportDialog.model" label-width="120px" ref="copyForm" :label-position="labelPosition">
                ...
                <el-form-item>
                    <el-button :loading="loading.listLoading" @click="saveImportAccount" type="primary">保存</el-button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.excelConvertUrl = $yid.config.API.BASE + "api-finance/uplshopaccount/importExcel";
            this.getData("1");
            this.getShopList();
        ...
        methods: {
            ...
            saveImportAccount() {
                if (this.mutiImportDialog.unionpays.length == 0) {
                    ...
                    service.finance.unionpaymanage.saveSystem(this.mutiImportDialog.unionpays).then(res => {
                        if (res.resp_code == 200) {
                ...
                service.finance.unionpaymanage.list(params).then(res=>{
                    if(res.resp_code=="200"){
                        if(res.data.length > 0){
                            download($yid.config.API.BASE + 'api-finance/uplshopaccount/expRecordsList', this.searchForm)
                        }else{
