<template>
  <div>
    <span
      >注：顾客总数量不等于新客，潜在会员，储值卡会员，资格卡会员，套餐会员简单相加。统计的是截至当天00:00的数据。</span
    >
    <yid-table ref="table" style="margin-top: 8px; width: 100%">
      <yid-table-column
        label="新客数"
        min-width="100"
        prop="nnum"></yid-table-column>
      <yid-table-column
        label="潜在会员数"
        min-width="100"
        prop="pnum"></yid-table-column>
      <yid-table-column
        label="储值卡会员数"
        min-width="100"
        prop="cnum"></yid-table-column>
      <yid-table-column
        label="资格卡会员数"
        min-width="100"
        prop="mnum"></yid-table-column>
      <yid-table-column
        label="套餐会员数"
        min-width="100"
        prop="pnum"></yid-table-column>
