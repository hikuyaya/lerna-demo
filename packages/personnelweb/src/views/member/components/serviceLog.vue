  ...
  <div>
    <el-form ref="searchForm" inline :model="searchForm">
      ...
      <el-form-item
        ...
        <el-select
          ...
          @change="getCraftsmans(searchForm.shopid)"
          filterable
    ...
    <yid-table pagination ref="table" style="margin-top: -5px; width: 100%">
      ...
      <yid-table-column
        label="编辑时间"
        min-width="200"
        prop="editDate"></yid-table-column>
      ...
      <yid-table-column
        label="问题分析"
        min-width="150"
        prop="content1"></yid-table-column>
      ...
      <yid-table-column
        label="反预约时间"
        min-width="200"
        prop="returnTime"></yid-table-column>
...
export default {
  ...
  methods: {
    ...
    getCraftsmans() {
      this.employeeList = []
      service.employee
        .listAll({ isDel: '0', shopid: this.searchForm.shopid })
        .then(res => {
