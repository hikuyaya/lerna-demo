  ...
  <div class="member-relation">
    ...
    <yid-dialog
      ...
      <el-row
        ...
        <el-button
          @click="meminfoDialog.showNum = 3"
          type="primary"
          :plain="meminfoDialog.showNum != 3"
          v-if="false"
          >账户调整
        </el-button>
        <el-button
        ...
        <table border="1" cellspacing="0">
          ...
          <tr>
            ...
            <td>
              <label
                class="marg5"
                :class="cardinfo.type == '1' ? '' : 'relationCardText'"
                @click="relationCard(cardinfo.type)"
                >{{
                  cardinfo.type == '1'
                    ? cardinfo.dawncmcode
                    : String(cardinfo.type) === ''
                    ? ''
                    : '关联实体卡'
                }}</label
              >
      ...
      <div class="meminfo" v-show="meminfoDialog.showNum == 2">
        ...
        <el-row>
          <el-col :offset="22" :span="1">
            <el-button type="primary" @click="saveMemberCard()"
              >确认修改</el-button
            >
          </el-col>
        </el-row>
