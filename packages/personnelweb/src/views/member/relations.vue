      ...
      <el-tab-pane label="会员分析查询" name="analyze">
        ...
        <yid-table pagination ref="table">
          ...
          <yid-table-column
            label="客单价"
            min-width="150"
            prop="univalent"></yid-table-column>
          <yid-table-column
            label="消费总额"
            min-width="150"
          ...
          <yid-table-column
            label="消费次数"
            min-width="150"
            prop="servNum"></yid-table-column>
          <yid-table-column
            label="消费频次"
            min-width="150"
            prop="serviceRate"></yid-table-column>
          <yid-table-column
            label="上次消费时间"
            min-width="150"
            prop="latelyTime"></yid-table-column>
          <yid-table-column
            label="上次服务员工"
            min-width="150"
            prop="lastEename"></yid-table-column>
    ...
    <yid-dialog
      ...
      <el-form label-width="140px" ref="copyForm">
        ...
        <el-form-item label="总卡金余额：" prop="money">
          <el-input
            v-model="searchForm.mintotalmoney"
            style="width: 100px"></el-input
          >-<el-input
            v-model="searchForm.maxtotalmoney"
            style="width: 100px"></el-input>
        </el-form-item>
        <el-form-item label="消费总额：" prop="servTotal">
          <el-input
            v-model="searchForm.minServTotal"
            style="width: 100px"></el-input
          >-<el-input
            v-model="searchForm.maxServTotal"
            style="width: 100px"></el-input>
        </el-form-item>
        <el-form-item label="消费次数：" prop="servNum">
          <el-input
            v-model="searchForm.minServNum"
            style="width: 100px"></el-input
          >-<el-input
            v-model="searchForm.maxServNum"
            style="width: 100px"></el-input>
        </el-form-item>
        <el-form-item label="未来店：" prop="missday">
          <el-input v-model="searchForm.missday" style="width: 100px"></el-input
          >至今天（有多少天未到店）
        </el-form-item>
        <el-form-item label="顾客来源：" prop="channel">
          <el-select
            ...
            filterable
            placeholder="请选择"
            v-model.trim="searchForm.channel">
            <el-option
              :key="item.id"
              :label="item.dcname"
              :value="item.id"
        ...
        <el-form-item label="所属员工：" prop="eename">
          <el-input v-model="searchForm.eename" style="width: 200px"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exportUsers() {
      ...
      service.member.userinfo
        .relationExport({ ...this.searchForm })
        .then(res => {
          if (res.resp_code == '200') {
