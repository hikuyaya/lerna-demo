  ...
  <div class="member-review">
    ...
    <yid-table pagination ref="table">
      ...
      <yid-table-column
        label="服务员工"
        min-width="150"
        prop="craftsman"></yid-table-column>
      <yid-table-column
        label="点评对象"
        min-width="150"
      ...
      <yid-table-column
        label="评论内容"
        min-width="150"
        prop="comment"></yid-table-column>
      <yid-table-column
        label="评价时间"
        min-width="150"
        prop="commentTime"></yid-table-column>
...
export default {
  ...
  methods: {
    ...
    exportComment() {
      ...
      download(
        yid.config.API.BASE +
          'api-member/servicerecords/chain/memServicelogExport',
        this.searchFormReq
      )
    },
    getShopList() {
