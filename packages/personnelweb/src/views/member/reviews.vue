    ...
    <div class="member-review">
        <el-form ref="searchForm" inline :model="searchForm">
            <el-form-item label="选择门店：">
                <el-select   @clear="clearFormShop" @blur="clearFormShop" clearable v-model="searchForm.shopid" filterable :filter-method="filterShop" placeholder="请选择">
        ...
        <yid-table pagination ref="table">
            ...
            <yid-table-column label="是否已回复" min-width="150" prop="isReply">
                <template slot-scope="scope">
                    <span v-if='scope.row.isReply == 0'>否</span>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.searchForm.saleTime.unshift(date1)
        ...
        methods:{
            ...
            exportComment(){
                ...
                download(yid.config.API.BASE + 'api-member/servicerecords/chain/memServicelogExport', this.searchFormReq)
            },
            getShopList() {
