  ...
  <div class="check_chstatistics">
    ...
    <yid-table pagination ref="table">
      ...
      <yid-table-column
        label="出勤天数"
        min-width="80"
        prop="days"></yid-table-column>
      <yid-table-column
        label="迟到次数"
        min-width="80"
        prop="delayDays"></yid-table-column>
      <yid-table-column
        label="早退次数"
        min-width="80"
        prop="earlyDay"></yid-table-column>
      <yid-table-column
        label="迟到/早退总时长(分钟)"
        min-width="100"
        prop="totalTime"></yid-table-column>
      <yid-table-column
        label="未打卡次数"
        min-width="100"
        prop="uncheck"></yid-table-column>
      <yid-table-column
        label="休息(天)"
        min-width="80"
        prop="rest"></yid-table-column>
      <yid-table-column
        label="学习(天)"
        min-width="80"
        prop="study"></yid-table-column>
      <yid-table-column
        label="旷工(天)"
        min-width="80"
        prop="absenteeism"></yid-table-column>
    </yid-table>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportTc() {
      ...
      download(
        $yid.config.API.BASE + 'api-pers/checkchstatistics/list/excel',
        params
      )
    },
    getShopList(params) {
