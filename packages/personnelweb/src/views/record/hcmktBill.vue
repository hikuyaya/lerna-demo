            ...
            <el-tab-pane label="开卡充值" name="assignment">
                <el-form ref="searchForm" inline :model="searchForm">
                    ...
                    <el-form-item label="主题活动：">
                        <el-input clearable v-model="searchForm.mktname" placeholder="活动编码/名称" style="width: 180px;"></el-input>
                    </el-form-item>
                    <el-form-item label="会员：">
                        <el-input clearable v-model="searchForm.memInfo" placeholder="姓名/手机/卡号" style="width: 180px;"></el-input>
                    </el-form-item>
                ...
                <yid-table pagination ref="table" style="margin-top: 15px;">
                    <yid-table-column label="原参加活动单号" min-width="180" prop="billcode"></yid-table-column>
                    <yid-table-column label="会员卡号" min-width="150" prop="cardno"></yid-table-column>
                    ...
                    <yid-table-column label="撤销活动" min-width="180" prop="mktname"></yid-table-column>
                    <yid-table-column label="赠送内容" min-width="180" prop="zsinfo">
                        <template slot-scope="scope">
                            <span>{{getZsInfo(scope.row)}}</span><br>
                        </template>
                    </yid-table-column>
                    <yid-table-column label="撤销时间" min-width="160" prop="hcTime"></yid-table-column>
                    <yid-table-column label="操作人" min-width="120" prop="hcBy"></yid-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            search(){
                ...
                if($yid.util.isEmpty(this.searchFormReq.hcTimeStart) || $yid.util.isEmpty(this.searchFormReq.hcTimeEnd)){
