 ...
 * @LastEditors: wqy
 * @LastEditTime: 2022-07-26 18:01:02
...
<template>
  <div class="container">
      ...
      <search-top ref="searchTop" :options="conditions">
        <template #inlineBtn>
          <div class="flex flex-alignitems__center mg-l-12">
            ...
            <el-button type="primary" @click="onCalculate">重新计算</el-button>
          </div>
        </template>
      </search-top>
    ...
    <el-dialog
      ...
      append-to-body
      width="480px">
      <calculate-comp v-if="calculateVisible" ref="calculateCompRef" />
      <span slot="footer" class="dialog-footer">
...
export default {
  components: { SearchTop, AddComp, RejectComp, CalculateComp },
  data() {
    return {
