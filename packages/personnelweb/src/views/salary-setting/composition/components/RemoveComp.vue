 ...
 * @LastEditors: wqy
 * @LastEditTime: 2022-07-21 14:03:41
 * @FilePath: \personnelweb\src\views\salary-setting\composition\components\RemoveComp.vue
 * @Description: 
-->
...
export default {
  data() {
    return {
      ...
      rules: {
        reason: [{ required: true, message: '请输入移除原因' }]
      }
    }
  },
  methods: {
