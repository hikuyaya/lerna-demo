    ...
    <div>
        <el-form ref="searchForm" inline :model="searchForm">
            <el-form-item label="门店："  prop="shopid"  :rules="[{ required: true, message: '必须选择一个门店'}]">
                <el-select @clear="clearFormShop" @blur="clearFormShop"  clearable v-model.trim="searchForm.shopid"  filterable :filter-method="filterShop" placeholder="请选择门店" style="width: 160px;" >
            ...
            <el-form-item label="部门">
                <el-select clearable filterable v-model="searchForm.branch"  @change="changeBranch" placeholder="请选择部门" style="width: 160px;">
                    <el-option
            ...
            <yid-table-column label="员工级别价格设置"  prop="special" width="180">
                <template slot-scope="scope">
                    <el-row type="flex" justify="space-between">
                        ...
                        <el-col :span="2"><i class="el-icon-document" @click="showSpecialDialog(scope.row)"></i></el-col>
                    </el-row>
                </template>
            </yid-table-column>
        ...
        <yid-dialog :title="specialDialog.title" :visible.sync="specialDialog.visible" @close="hideSpecialDialog" width="auto">
            ...
            <yid-table ref="specialTable" style="margin-top: 15px;" :data="specialDialog.specialRows">
                <yid-table-column label="名称"  prop="pslname" width="120"></yid-table-column>
                <yid-table-column label="级别价格"  prop="specialPrice" width="120"></yid-table-column>
