    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="员工级别" name="level">
        <el-input
          clearable
          filterable
          v-model="searchLevelName"
          placeholder="编码/名称"
          style="width: 150px"></el-input
        >&nbsp;
        <el-button
          @click="getlevelList(status2 == '1' ? '2' : '1')"
          type="primary"
          >查询</el-button
        >&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <el-button @click="lookup2()"
          >查看{{ status2 == '2' ? '禁用' : '正常' }}的职位级别</el-button
        >
        <yid-table
          pagination
          ref="leveltable"
    ...
    <yid-dialog
      ...
      <el-form ref="positionForm" :model="positionForm" label-width="140px">
        <el-form-item
          label="职位类型编号："
          prop="pscode"
          :rules="[{ required: true, message: '职位类型编号为空' }]">
          {{ positionForm.pscode }}
        </el-form-item>
        <el-form-item
          label="职位名称："
          prop="psname"
          :rules="[{ required: true, message: '职位名称为空' }]">
        ...
        <el-form-item
          ...
          <el-select
            value-key="id"
            placeholder="请选择同步业务组"
            v-model.trim="positionForm.deptObj"
            multiple>
            <el-option
              :key="item.id"
              :value="item"
              :label="item.bname"
              v-for="item in deptDataAll" />
          </el-select>
        </el-form-item>
        <el-form-item>
    ...
    <yid-dialog
      ...
      <el-form ref="levelForm" :model="levelForm" label-width="140px">
        <el-form-item
          label="员工级别编号："
          prop="pslcode"
          :rules="[{ required: true, message: '员工级别编号为空' }]">
          {{ levelForm.pslcode }}
        </el-form-item>
        <el-form-item
          label="级别名称："
          prop="pslname"
          :rules="[{ required: true, message: '级别名称为空' }]">
          <el-input v-model="levelForm.pslname"></el-input>
        </el-form-item>
        <el-form-item
          label="所属职位类型："
          prop="jobObj"
          :rules="[{ required: true, message: '所属职位类型为空' }]">
          <el-select
            value-key="id"
            placeholder="请选择所属职位类型"
            v-model.trim="levelForm.jobObj">
            <el-option
              v-for="val in jobDataAll"
              :key="val.id"
              :value="val.id"
              :label="val.psname" />
          </el-select>
