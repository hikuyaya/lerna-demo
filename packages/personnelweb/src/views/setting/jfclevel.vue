  ...
  <div class="jfclevel">
    ...
    <yid-table
      ...
      <yid-table-column
        label="接发级别"
        min-width="150"
        prop="jfClname"></yid-table-column>
      <yid-table-column label="操作" min-width="250">
        <template slot-scope="scope">
          <el-link type="primary" @click="editEeJfList(scope.row)"
            >编辑</el-link
          >
        </template>
      </yid-table-column>
    ...
    <yid-dialog
      :title="jfDialog.title"
      :visible.sync="jfDialog.visible"
      width="450px">
