            ...
            <el-tab-pane label="短信发送记录" name="logs">
                <el-form inline ref="sendRecord">
                    <el-form-item label="门店：">
                        <el-select clearable @clear="clearFormShop" @blur="clearFormShop" v-model.trim="sendRecord.shopid" filterable :filter-method="filterShop" placeholder="请选择" style="width: 160px;">
