  ...
  <div class="dept">
    ...
    <yid-table ref="table" :data="payDatas">
      ...
      <yid-table-column
        label="支付类型"
        min-width="60"
        prop="ptname"></yid-table-column>
      <yid-table-column
        label="扣手续费率（%）"
        min-width="100"
        prop="freeRate"></yid-table-column>
      <yid-table-column
        label="业绩比率（%）"
        min-width="100"
        prop="yjRate"></yid-table-column>
    ...
    <yid-dialog
      ...
      <el-form
        ...
        ref="eidtForm">
        <el-form-item label="支付名称：" prop="payname">
          <label> {{ editDialog.payname }}</label
          ><br />
        </el-form-item>
        <el-form-item label="支付类型：" prop="ptname">
          <label> {{ editDialog.ptname }}</label
          ><br />
        </el-form-item>
        <!--<el-form-item label="自定义字段：" prop="memoname">-->
        ...
        <el-form-item label="费率（%）：" prop="freeRate">
          <el-input
            ...
            min="0"
            placeholder="费率"
            v-model="editDialog.freeRate" /><br />
        </el-form-item>
        <el-form-item label="业绩比率（%）：" prop="yjRate">
          <el-input
            type="number"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      payRules: {
        payname: [
          { required: true, message: '请填写支付名称' },
          { min: 0, max: 10, message: '支付名称在10个字符以内' }
        ],
