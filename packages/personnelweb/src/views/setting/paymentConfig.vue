<template>
    ...
    <div v-show="listShow">
        ...
        <el-form ref="searchForm" inline :model="searchForm" style="margin-top: 16px">
            <el-form-item label="模板：">
                <el-input clearable v-model="searchForm.pcodename" placeholder="方案编码/方案名称"  style="width: 180px;"></el-input>
            </el-form-item>
            <el-form-item >
        ...
        <yid-table pagination ref="table">
            <yid-table-column label="编码" min-width="100" prop="code"></yid-table-column>
            <yid-table-column label="模板名称" min-width="100" prop="name"></yid-table-column>
            <yid-table-column label="备注" min-width="100" prop="memo"></yid-table-column>
            <yid-table-column label="操作" min-width="100" prop="memname">
                <template slot-scope="scope" fixed="right">
                    <el-link type="primary" @click="showAddDialog(scope.row)" >编辑</el-link>
                    <el-link type="primary" @click="showSetting(scope.row)" style="margin-left: 6px">设置模板</el-link>
                </template>
            </yid-table-column>
        </yid-table>
    </div>
    ...
    <el-dialog :title="addTemplateDialog.title" :visible.sync="addTemplateDialog.visible" width="450px">

        <el-form ref="templateForm" inline :model="templateForm" label-width="140px" >
            <el-form-item label="模板编号:" prop="code">
                {{templateForm.code}}<explain style="color:silver">编号从001开始自动叠加</explain>
            </el-form-item>
            <el-form-item label="模板名称：" prop="name" :rules="[{ required: true, message: '模板名称不能为空'}]">
                    <el-input clearable v-model="templateForm.name" placeholder="模板名称"  style="width: 180px;"></el-input>
            </el-form-item>
