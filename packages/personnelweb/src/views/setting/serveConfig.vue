<template>
  <div class="dept">
    <el-form inline>
      ...
      <!--</el-form-item>-->
      <el-form-item label="">
        <el-button type="primary" @click="mutiImportAlert()"
          >批量导入服务项目</el-button
        >
      </el-form-item>
      <el-form-item label="">
        <el-button type="primary" @click="exportServs()"
          >导出服务项目</el-button
        >
      </el-form-item>
      <!--<el-form-item label="">
    ...
    <yid-table
      ...
      <yid-table-column label="名称" prop="servname" width="160">
        <template slot-scope="scope">
          <label style="color: blue" @click="editService(scope.row)">{{
            scope.row.servname
          }}</label>
        </template>
      </yid-table-column>
    ...
    <yid-dialog
      ...
      <el-form :model="addDialog" label-width="150px" ref="copyForm">
        ...
        <el-form-item
          ...
          <el-select
            v-model="addDialog.servtid"
            @change="changeServType"
            placeholder="请选择类别"
        ...
        <el-form-item label="指定业绩减扣：">
          ...
          <el-input
            v-if="addDialog.kytype == '1' || addDialog.kytype == '2'"
            clearable
            v-model="addDialog.kyvalue"
          ...
          <el-popover
            ...
            <ul v-if="addDialog.kytype == '0'" class="tips-content">
              ...
              <li>指定业绩设置的数值。</li>
              <li>
                最终获得业绩=(成交额+(加收/减扣)-指定业绩减扣)*支付方式扣除的业绩比率
              </li>
            </ul>
        ...
        <el-form-item label="回访短信：">
          ...
          <el-popover
            ...
            <ul class="tips-content">
              ...
              <li>
                系统将自动发送短信到顾客手机上回访，顾客收到短信后可直接回复,
              </li>
        ...
        <el-form-item label="服务工位特殊配置：">
          <el-switch
            ...
            @change="updateStatus(addDialog.isOpen)">
          </el-switch>
        </el-form-item>
        <el-form-item
          label="第一工位可选人数："
          ...
          <el-input
            ...
            min="1"
            max="100"
            v-model="addDialog.firstStation" /><br />
        </el-form-item>
        <el-form-item
          label="第二工位可选人数："
          style="width: 280px"
        ...
        <el-form-item
          ...
          <el-input
            ...
            min="1"
            max="100"
            v-model="addDialog.threeStation" />
        </el-form-item>
        <el-form-item>
    ...
    <yid-dialog
      :title="mutiImportDialog.title"
      :visible.sync="mutiImportDialog.visible"
      @close="levelCancel"
      width="700px">
      <el-form
        :model="mutiImportDialog.model"
        label-width="120px"
        ref="copyForm"
        ...
        <el-form-item label="下载导入模板：" align="left">
          <el-link type="primary" @click="downExcelTemplate()"
            >服务项目模板</el-link
          >
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    saveService() {
      ...
      if (
        this.addDialog.firstStation < 1 ||
        this.addDialog.firstStation > 100
      ) {
        this.addDialog.firstStation = 1
      }
      ...
      if (
        this.addDialog.threeStation < 1 ||
        this.addDialog.threeStation > 100
      ) {
        this.addDialog.threeStation = 1
      }
