  ...
  <div class="dept">
    <el-form inline>
      <el-form-item label="">
        ...
        <el-button type="primary" @click="deleteShopPriceContr()">移除</el-button>
      </el-form-item>
      <br/>
      <el-form-item label="业务类型：">
        <el-select clearable v-model="form.type" placeholder="请选择业务类型" label-width="150px">
      ...
      <el-form-item label="状态">
        <el-select clearable v-model="form.priceControl" placeholder="请选择状态" style="width: 120px;">
      ...
      <el-form-item label="">
        <el-button type="primary" @click="queryShopPriceControl()">查询</el-button>
      </el-form-item>
    </el-form>
    <yid-table ref="tableService" pagination style="width: 90%;" :data="dataList" @selection-change="selectionData">
      ...
      <yid-table-column label="门店编码" prop="shopcode" width="120"></yid-table-column>
      <yid-table-column label="门店名称" prop="shopname" width="120"></yid-table-column>
      <yid-table-column label="所属价格体系" prop="pricename" width="140"></yid-table-column>
      <yid-table-column label="添加时间" prop="createdTime" width="120"></yid-table-column>
      <yid-table-column label="修改时间" prop="updatedTime" width="120"></yid-table-column>
      <yid-table-column label="操作人" prop="createdBy" width="120"></yid-table-column>
    ...
    <yid-dialog :title="shopDialog.title" :visible.sync="shopDialog.visible"
                width="1200px">
    ...
    <yid-dialog :title="priceControlData.title" :visible.sync="priceControlData.visible" width="500px">
...
export default {
  ...
  data() {
    return {
      ...
      regions: [],
      flag:false,
      types: [{name:'美发',value:'1'},{name:'美容',value:'2'}],
      defaultProps: {
        children: 'children',
        label: 'name',
      },
    ...
    addShop(){
      this.selectShops.map(m =>{
          ...
          if(flag){
            ...
            this.shopDialog.shoplist.push({shopid:m.id,shopcode:m.shopcode,shopname:m.shopname,pricename:m.pricename,type:m.type});
    ...
    save() {
      if (this.isShow) {
        if (this.priceControlData.priceControl) {
          ...
          service.chain.servShop.saveOrUpdate(this.shopDialog.shoplist).then(res =>{
