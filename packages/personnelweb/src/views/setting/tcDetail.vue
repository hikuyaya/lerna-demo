  ...
  <div class="tcTon">
    ...
    <el-row style="display: flex; margin: 15px 0">
      ...
      <el-checkbox
        ...
        v-show="rItem.prtcode == '001' || rItem.prtcode == '005'"
        >支付方式</el-checkbox
      >
          ...
          <td width="51%" v-show="showGroup.show_norm">
            <table
              ...
              <tr>
                ...
                <td rowspan="2" width="100" v-show="dialogTcx.prtcode == '001'">
                  指定提成
                </td>
                <td rowspan="2" width="100" v-show="dialogTcx.prtcode == '001'">
                  不指定提成
              ...
              <td
                ...
                <table
                  ...
                  <tr height="36" v-for="(level, j) in desc.levelList">
                    ...
                    <td width="90">
                      <el-row>
                        <el-link type="primary" @click="levelCopy(i, j)"
                          >复制</el-link
                        >
                        <el-link
                          type="primary"
...
export default {
  ...
  methods: {
    ...
    setRItem(rItem) {
      ...
      this.showGroup.show_position =
        this.rItem.descList[0] && this.rItem.descList[0].isPosition == '1'
          ? true
          : false
    ...
    toAddDesc() {
      ...
      this.dialogTcx.index = this.rItem.descList
        ? this.rItem.descList.length
        : 0
      this.dialogTcx.prtcode = this.rItem.prtcode
    },
