    ...
    <div class="tcTon">
        ...
        <table border="1" bordercolor="#ebeef5" width="100%" class="tcbiaot" cellpadding="0" cellspacing="0">
            ...
            <tr height="40">
                ...
                <td width="51%" v-show="showGroup.show_norm">
                    <table width="100%" class="licengborder" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td rowspan="2" width="100" v-show="dialogTcx.prtcode=='001'">指定提成</td>
                            <td rowspan="2" width="100" v-show="dialogTcx.prtcode=='001'">不指定提成</td>
                            <td rowspan="2" width="100" v-show="dialogTcx.prtcode!='001'">提成</td>
                ...
                <td v-show="!showGroup.show_norm&&dialogTcx.prtcode=='001'">指定提成</td>
                <td v-show="!showGroup.show_norm&&dialogTcx.prtcode=='001'">不指定提成</td>
                <td v-show="!showGroup.show_norm&&dialogTcx.prtcode!='001'">提成</td>
            ...
            <tr height="40" class="td_content" v-for="(desc,i) in rItem.descList">
                            ...
                            <td colspan="5" style="padding: 0" v-show="desc.levelList.length>0">
                                <table width="100%" border="0" class="td_bottom_zb" cellpadding="0" cellspacing="0">
                                    <tr height="36" v-for="(level,j) in desc.levelList">
                                        ...
                                        <!--指标提成-指定-->
                                        <td width="100" v-show="dialogTcx.prtcode=='001'">
                                            <el-row type="flex" justify="space-between">
                                                <el-col :span="18">
                ...
                <!--指定-->
                <td v-show="!showGroup.show_norm&&dialogTcx.prtcode=='001'">
                    <el-row type="flex" justify="space-between">
                        <el-col :span="18">
...
<script>
    ...
    export default {
        ...
        mounted() {
            service.chain.payType.payTypeList().then(res => {
                this.pays = res.data
            })
        },
        watch: {
        ...
        methods: {
            ...
            getFullItem(priid) {
                service.chain.royaltyItem.getFullItem(priid).then(res => {
            ...
            save() {
                ...
                service.chain.royaltyItem.save(this.rItem).then(res => {
                    this.setRItem(res.data);
