      ...
      <div v-show="visibleList.manage">
        ...
        <el-form
          ...
          <el-form-item label="门店：" prop="scodename">
            <el-input
              v-model="searchForm.scodename"
              clearable
              style="width: 150px"
              placeholder="门店编码/门店名称"></el-input>
          </el-form-item>
          ...
          <yid-table-column label="适用门店" prop="shopList">
            <template slot-scope="scope">
              <div>
                <el-row gutter="8"
                  >共{{
                    scope.row.shopList ? scope.row.shopList.length : 0
                  }}家门店</el-row
                >
                <el-row gutter="8">
        ...
        <yid-dialog
          ...
          <el-form
            ...
            <el-form-item label="适用门店:" prop="shopList">
              <el-button type="primary" @click="selectShop()"
                >选择门店</el-button
              >
              {{
                dialogType.model.shopList &&
                dialogType.model.shopList.length > 0
                  ? '共选中' + dialogType.model.shopList.length + '家门店'
                  : ''
              }}
            </el-form-item>
      ...
      <el-row type="flex" justify="space-between">
        <el-form inline :model="shopSearchForm" ref="shopSearchForm">
          ...
          <el-form-item label="门店提成方案：" prop="noroyalty">
            <el-select
              style="width: 100px"
              v-model="shopSearchForm.noroyalty"
              clearable
              placeholder="请选择">
  ...
  methods: {
    ...
    saveShop() {
      if (this.shopDialog.isContainRoyaltyShop) {
        yid.util.confirm(
          '选择的门店包括已设置提成方案的门店，保存后将会从原提成方案移至本方案中！',
          '',
          '',
          () => {
