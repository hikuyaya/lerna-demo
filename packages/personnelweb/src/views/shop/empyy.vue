<template>
  <div class="dept">
    <el-form
      ...
      <el-form-item label=""
        ><el-button type="primary" @click="queryEmpData()"
          >查询</el-button
        ></el-form-item
      ><br />
    </el-form>
    <el-row
      ><el-col
        ...
        可拖动列表的每一行进行排序，该排序将显示在顾客端设计师列表</el-col
      ></el-row
    >
...
export default {
  ...
  methods: {
    changeSelectShop() {
      ...
      service.branch
        .getListByShopType({
          shopid: selectShopObj.shopid,
          type: selectShopObj.type,
          isDel: '0',
          status: '1'
        })
        .then(res => {
