    ...
    <div class="checkProducts">
        <el-form :model="searchForm" inline ref="searchForm">
            <el-form-item label="产品编码：" prop="pcode">
                <el-input clearable  autofocus placeholder="产品编码" v-model.trim="searchForm.pcode" style="width: 130px;"></el-input>
            </el-form-item>
            <el-form-item label="产品品牌：" prop="brand">
                <el-select clearable filterable placeholder="请选择产品品牌" style="width: 140px;" v-model.trim="searchForm.brand">
                    <el-option
            ...
            <el-form-item label="产品品类：" prop="categrory">
                <el-select clearable value-key="id" filterable placeholder="请选择" v-model.trim="searchForm.categrory">
        ...
        <yid-table pagination ref="table"  style="margin-top: 15px;" @selection-change="handleSelectionChange">
            ...
            <yid-table-column label="产品编码" width="100" prop="pcode" ></yid-table-column>
            <yid-table-column label="产品名称" prop="pname"></yid-table-column>
            <yid-table-column label="品牌" prop="bname">
            </yid-table-column>
            <yid-table-column label="类别" prop="cname">
            </yid-table-column>
