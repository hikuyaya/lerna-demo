<template>
  <div class="stock-info">
    ...
    <yid-table
      ...
      :row-class-name="$yid.util.getStockClass">
      <yid-table-column
        label="产品编码"
        min-width="150"
      ...
      <yid-table-column
        label="安全库存"
        min-width="100"
        prop="safeStock"></yid-table-column>
      <yid-table-column
        label="平均成本"
        min-width="100"
        prop="averageCost"></yid-table-column>
      <yid-table-column
        label="库存总金额"
        min-width="100"
      ...
      <yid-table-column
        label="客户库存"
        min-width="100"
        prop="customerStock"></yid-table-column>
