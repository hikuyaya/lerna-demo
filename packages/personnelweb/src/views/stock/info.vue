    ...
    <div class="stock-info">
        <el-form ref="searchForm" inline :model="searchForm">
            ...
            <el-form-item label="产品品牌："  prop="brand">
                <el-select clearable filterable placeholder="请选择产品品牌" style="width: 180px;" v-model.trim="searchForm.bname">
                    <el-option :key="item.id" :label="item.bname" :value="item.bname" v-for="item in searchProductBrandList"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="产品品类：" prop="categrory">
                <el-select clearable filterable placeholder="请选择产品品类" style="width: 180px;" v-model.trim="searchForm.ccode">
                    <el-option-group v-for="group in categroryList" :key="group.id" :label="group.cname">
                        <el-option v-for="item in group.categroryListz" :key="item.id" :label="item.cname" :value="item.ccode"></el-option>
                    </el-option-group>
                </el-select>
            </el-form-item>
