        ...
        <div v-show="listShow">
            <el-form :model="searchForm" inline ref="searchForm">
                ...
                <el-form-item label="门店：" prop="shopid">
                    <el-select clearable v-model="searchForm.shopid" @clear="clearFormShop" @blur="clearFormShop"  filterable :filter-method="filterShop" placeholder="请选择门店" style="width: 160px;">
