    ...
    <el-collapse-transition>
      <div v-show="showList">
        <el-form ref="searchForm" inline :model="searchForm">
          ...
          <!--</el-form-item>-->
          <el-form-item label="">
            <el-button @click="mutiImportProduct" type="primary"
              >批量导入</el-button
            >
          </el-form-item>
          <br />
          ...
          <el-form-item label="产品品牌：" prop="brand">
            <el-select
              ...
              <el-option
                ...
                :label="item.bname"
                :value="item.id"
                v-for="item in searchProductBrandList"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="是否允许客装销售：" prop="status">
            <el-select
              clearable
              filterable
              placeholder="请选择"
              v-model.trim="searchForm.iskz"
              style="width: 100px">
        ...
        <yid-table
          ...
          <yid-table-column
            ...
            label="售价"
            width="80"></yid-table-column>
          <yid-table-column prop="iskz" label="是否允许客装销售" width="100">
          ...
          <yid-table-column label="操作" min-width="100" prop="content">
            <template slot-scope="scope">
              <el-link type="primary" @click="editProduct(scope.row)"
                >编辑</el-link
              >
            </template>
          </yid-table-column>
          ...
          <el-row :gutter="20">
            <el-col :span="10">
              <el-form-item
                ...
                <el-input
                  v-model="productForm.pcode"
                  :disabled="isEditCode"
                  placeholder="产品编码"
                  style="width: 200px"
                  @change="checkPcode"></el-input>
              </el-form-item>
              ...
              <el-form-item
                ...
                <el-input
                  v-model="productForm.pname"
                  placeholder="请填写16汉字以内名称"
                  style="width: 200px"></el-input>
              </el-form-item>

              <el-form-item label="产品规格：" prop="norms">
                <el-input
                  v-model="productForm.norms"
                  placeholder="规格"
                  style="width: 200px"></el-input>
              </el-form-item>
              ...
              <el-form-item
                ...
                <el-select
                  ...
                  filterable
                  placeholder="请选择"
                  v-model.trim="productForm.brandObj"
                  @change="getBrandList">
                  <el-option
                    :key="item.id"
                    :label="item.bname"
              ...
              <el-form-item
                ...
                <el-select
                  ...
                  filterable
                  placeholder="请选择"
                  v-model.trim="productForm.categroryObj"
                  @change="getCategroryList">
                  <el-option-group
                    v-for="group in categroryList"
                    :key="group.id"
              ...
              <el-form-item
                label="是否客装销售："
                prop="iskz"
                :rules="[{ required: true, message: '是否客装销售不能为空' }]">
            ...
            <el-col :span="10">
              <el-form-item label="产品图片：" prop="photo">
                ...
                <el-button @click="handleRemove" type="primary"
                  >移除图片</el-button
                >
              </el-form-item>
            </el-col>
  ...
  methods: {
    ...
    saveImportProducts() {
      if (this.mutiImportDialog.products.length == 0) {
        ...
        service.product
          .batchImport({ maps: this.mutiImportDialog.products })
          .then(res => {
            if (res.resp_code == 200) {
        ...
        if (valid) {
          ...
          if (Number(this.productForm.iskz) == 1) {
            if (
              ...
              this.productForm.price.length == 0
            ) {
          ...
          if (
            ...
            this.productForm.status.length == 0
          ) {
          ...
          service.product.saveProduct(this.productForm).then(async res => {
            if (res.resp_code == 200) {
              if (
                this.productForm.id != null &&
                this.productForm.id.length > 0
              ) {
                let stockProduck = {}
    ...
    updateStatus(data) {
      ...
      //判断是否存在套餐使用该产品
      if (data.status == '2') {
        service.product.checkPackage(data.id).then(res => {
