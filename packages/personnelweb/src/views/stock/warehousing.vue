    ...
    <div class="stock-outStock">
            ...
            <yid-table-column label="操作" min-width="240" fixed="right">
              <template slot-scope="scope">
                <el-button
                  ...
                  >删除</el-button
                >
                <el-button type="text" @click="showStockCon(scope.row)"
                  >明细</el-button
                >
      ...
      <el-collapse-transition>
        <div v-show="!listShow">
          <warehousingCon
            ref="detailPage"
            @onClose="closeDetailPage"></warehousingCon>
        </div>
      </el-collapse-transition>
    </div>
  </div>
