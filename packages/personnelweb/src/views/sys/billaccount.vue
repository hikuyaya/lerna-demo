        ...
        <el-form :model="searchForm" ref="searchForm" inline>
          <el-form-item
            ...
            <el-select
              clearable
              placeholder="请选择"
              v-model.trim="searchForm.btid"
              style="width: 150px">
              <el-option
                v-for="item in btnames"
                :value="item.code"
      ...
      <el-tab-pane label="未结算单据" name="wjbill">
        <el-form :model="searchBill" ref="searchwjBill" inline>
          ...
          <el-form-item label="店号：">
            <el-input
              clearable
              placeholder="请输入"
              v-model.trim="searchBill.shopcode"
          ...
          <el-form-item label="单号：">
            <el-input
              clearable
              placeholder="请输入"
              v-model.trim="searchBill.billcode"
              style="width: 160px"></el-input>
          </el-form-item>
          <el-form-item label="日期" prop="date">
            <el-date-picker
              style="width: 320px"
              v-model="searchBill.date"
        ...
        <yid-table pagination ref="wjTable" style="margin-top: 15px">
          ...
          <yid-table-column
            label="结算次数"
            min-width="100"
            prop="jobcount"></yid-table-column>
          <yid-table-column
            label="结算日志"
            min-width="180"
            prop="joblog"></yid-table-column>
        </yid-table>
      </el-tab-pane>
