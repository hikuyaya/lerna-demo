      ...
      <avue-form
        ...
        <template slot-scope="scope" slot="reportSql">
          <el-row style="width: 100%">
            ...
            <el-col :span="2">
              <el-button type="primary" @click="handleSQLAnalyze"
                >SQL解析</el-button
              >
              <el-button type="primary" @click="handleSQLAnalyzeResult"
                >解析结果</el-button
              >
            </el-col>
          </el-row>
        ...
        <template slot-scope="scope" slot="reportJs">
          <el-row style="width: 100%">
            ...
            <el-col :span="2">
              <el-button type="primary" @click="handleJsAnalyze"
                >js语法验证</el-button
              >
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    async doSave(e) {
      ...
      if (
        !this.formobj.isPage &&
        (this.formobj.isPrint || this.formobj.isSummary)
      ) {
    ...
    async handleSQLAnalyze() {
      ...
      const res = await service.report
        .parseSql(this.formobj.dbSource, {
      ...
      try {
        ...
        for (var i = 0; i < list.length; i++) {
          ...
          let filterElement = that.itemList.filter(
    ...
    async handleSQLAnalyzeResult() {
      ...
      let that = this
      const res = await service.report
        .parseSqlResult(this.formobj.dbSource, {
          sql: this.formobj.reportSql,
          ...data
        })
        .catch(() => {
