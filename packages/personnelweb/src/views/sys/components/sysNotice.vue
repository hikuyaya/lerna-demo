<template>
  <div class="sys-notice">
    <div>
      ...
      <el-button @click="showPublishFormDialog" type="primary"
        >发布通知</el-button
      >
    </div>
    ...
    <yid-dialog
      ...
      <el-form :model="publishForm" label-width="140px" ref="publishForm">
        ...
        <el-form-item>
          <el-button @click="publish('publishForm')" type="primary"
            >发布</el-button
          >
        </el-form-item>
      </el-form>
