    ...
    <div >
        <el-form :model="searchForm" ref="searchForm" inline>
            <el-form-item label="授权码：">
                <el-input clearable placeholder="请输入" v-model.trim="searchForm.macaddress" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="最近登录时间">
                <el-date-picker style="width:320px;"
                                v-model="searchForm.logindate" value-format="yyyy-MM-dd"
                                type="daterange"
                                start-placeholder="开始日期" range-separator="至" end-placeholder="结束日期">
                </el-date-picker>
            </el-form-item><br/>
            <el-form-item label="授权状态：">
                <el-select clearable placeholder="请选择" v-model.trim="searchForm.status" style="width: 150px;" >
                    <el-option label="启用" value="1"></el-option>
                    <el-option label="停用" value="2"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="备注：">
                <el-input clearable placeholder="请输入" v-model.trim="searchForm.memo" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <yid-table pagination ref="macTable" style="margin-top: 15px;" @selection-change="handleSelectionChange">
            <el-table-column  type="selection"  width="55"></el-table-column>
            <yid-table-column label="授权码" min-width="150" prop="macaddress">
                <template slot-scope="scope">
                    <el-link type="primary" @click="showEdit(scope.row)">{{scope.row.macaddress}}</el-link>
                </template>
            </yid-table-column>
            <yid-table-column label="最近登录账户" min-width="60" prop="lastloginid"></yid-table-column>
            <yid-table-column label="最近登录使用人" min-width="60" prop="lastloginname"></yid-table-column>
            <yid-table-column label="最近登录时间" width="150" prop="lastlogintime"></yid-table-column>
            <yid-table-column label="门店编码" width="90" prop="shopcode"></yid-table-column>
            <yid-table-column label="门店名称" width="100" prop="shopname"></yid-table-column>
        ...
        <yid-dialog :title="dialog.title" :visible="dialog.visible" @close="closeDialog" width="550px">
            <el-form ref="macForm" :model="macForm" label-width="100px">
                <el-form-item label="授权码" prop="macaddress" :rules="[{ required: true, message: '授权码不能为空'}]">
                    <el-input  v-model="macForm.macaddress" placeholder="请输入" style="width: 200px;"></el-input>
                </el-form-item>
                ...
                <el-form-item label="备注" prop="memo" >
                    <el-input v-model="macForm.memo" type="textarea" :rows="3" placeholder="备注" style="width: 60%;"/>
                </el-form-item>
                <el-form-item label=" ">
