        ...
        <el-collapse-transition>
            <div v-show="showList">
                ...
                <yid-table ref="table" pagination style="width: 100%;margin-top: 10px;">
                    ...
                    <yid-table-column prop="sreservfund" label="日常备用金" width="130"></yid-table-column>
                ...
                <el-form ref="fundShopForm" :model="fundShopForm" style="margin-top: 16px" :rules="rules"
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            ...
                            <el-form-item label="日常备用金：" prop="sreservfund" :rules="[{ required: true, message: '门店店号不能为空'}]">
                                <el-input v-model="fundShopForm.sreservfund"
    ...
    export default {
        ...
        methods: {
            ...
            async editAction(row) {
                ...
                this.fundShopForm.sreservfund = row.sreservfund;
