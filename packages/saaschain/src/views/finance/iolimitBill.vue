            ...
            <div v-show="showList">
                ...
                <el-form ref="searchForm" inline :model="searchForm">
                    ...
                    <el-form-item label="门店：" label-width="100px">
                        <el-select @clear="clearFormShop" clearable v-model.trim="searchForm.shopid" filterable
                    ...
                    <el-form-item label="项目名称：" label-width="100px">
                        <el-select @clear="clearFormReserve" clearable v-model.trim="searchForm.reserveid" filterable
        ...
        <el-collapse-transition>
            <div v-show="!showList">
                ...
                <yid-table v-show="showButton" ref="itemTable" style="margin-top: 15px;" :data="billForm.details">
                    ...
                    <yid-table-column label="支出项目名称" min-width="180" prop="reserveid">
                        <template slot-scope="scope">
                            <el-select v-model.trim="scope.row.iocode" placeholder="请选择" style="width: 150px;" @change="getReseveJe(scope.row)">
                    ...
                    <yid-table-column label="修改限制金额" min-width="120" prop="umoney">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.umoney" @blur="calcBalance(scope.row)"></el-input>
                        </template>
                    </yid-table-column>
                    <yid-table-column label="实际限制金额" min-width="100" prop="rmoney"></yid-table-column>
                ...
                <yid-table v-show="!showButton" ref="showTable" style="margin-top: 15px;" :data="billForm.details">
                    <yid-table-column label="门店编码" min-width="100" prop="shopcode"></yid-table-column>
                    <yid-table-column label="门店名称" min-width="150" prop="shopname"></yid-table-column>
                    <yid-table-column label="预留款类型" min-width="150" prop="ioname"></yid-table-column>
                    <yid-table-column label="原金额" min-width="80" prop="smoney"></yid-table-column>
